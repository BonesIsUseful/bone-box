...
export class ExportPrompt  {
     ...
     __init() {this.outputStarted = false}
      __init2() {this._fileName = input({ type: "text", style: "width: 10em;", value: "BeepBox-Song", maxlength: 250, "autofocus": "autofocus" })}
      __init3() {this._computedSamplesLabel = div({ style: "width: 10em;" }, new Text("0:00"))}
      __init4() {this._enableIntro = input({ type: "checkbox" })}
      __init5() {this._loopDropDown = input({ style: "width: 2em;", type: "number", min: "1", max: "4", step: "1" })}
      __init6() {this._enableOutro = input({ type: "checkbox" })}
      __init7() {this._formatSelect = select({ style: "width: 100%;" },
      ...
      __init8() {this._cancelButton = button({ class: "cancelButton" })}
      __init9() {this._exportButton = button({ class: "exportButton", style: "width:45%;" }, "Export")}
      __init10() {this._outputProgressBar = div({ style: `width: 0%; background: ${ColorConfig.loopAccent}; height: 100%; position: absolute; z-index: 2;` })}
      __init11() {this._outputProgressLabel = div({ style: `position: relative; top: -1px; z-index: 3;` }, "0%")}
      __init12() {this._outputProgressContainer = div({ style: `height: 12px; background: ${ColorConfig.uiWidgetBackground}; display: block; position: relative; z-index: 1;` },
        this._outputProgressBar,
        this._outputProgressLabel,
    )}
     static  __initStatic() {this.midiChipInstruments = [
      ...
      __init13() {this.container = div({ class: "prompt noSelection", style: "width: 200px;" },
        h2("Export Options"),
    ...
    constructor( _doc) {;this._doc = _doc;ExportPrompt.prototype.__init.call(this);ExportPrompt.prototype.__init2.call(this);ExportPrompt.prototype.__init3.call(this);ExportPrompt.prototype.__init4.call(this);ExportPrompt.prototype.__init5.call(this);ExportPrompt.prototype.__init6.call(this);ExportPrompt.prototype.__init7.call(this);ExportPrompt.prototype.__init8.call(this);ExportPrompt.prototype.__init9.call(this);ExportPrompt.prototype.__init10.call(this);ExportPrompt.prototype.__init11.call(this);ExportPrompt.prototype.__init12.call(this);ExportPrompt.prototype.__init13.call(this);ExportPrompt.prototype.__init14.call(this);ExportPrompt.prototype.__init15.call(this);ExportPrompt.prototype.__init16.call(this);ExportPrompt.prototype.__init17.call(this);
