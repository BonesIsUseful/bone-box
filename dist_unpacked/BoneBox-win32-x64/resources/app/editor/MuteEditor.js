...
import { InputBox } from "./HTMLWrapper.js";
import { ChangeChannelOrder, ChangeChannelName, ChangeRemoveChannel } from "./changes.js";
...
export class MuteEditor {
	 ...
	 __init() {this._cornerFiller = HTML.div({style: `background: ${ColorConfig.editorBackground}; position: sticky; bottom: 0; left: 0; width: 32px; height: 30px;`})}
	
	  __init2() {this._buttons = []}
	  __init3() {this._channelCounts = []}
	  __init4() {this._channelNameDisplay = HTML.div({ style: `background-color: ${ColorConfig.uiWidgetFocus}; white-space:nowrap; display: none; transform:translate(20px); width: auto; pointer-events: none; position: absolute; border-radius: 0.2em; z-index: 2;`, "color": ColorConfig.primaryText }, "")}
	  ...
	  __init6() {this._channelDropDown = HTML.select({ style: "width: 0px; left: 19px; height: 19px; position:absolute; opacity:0" },
	  ...
	  __init7() {this.container = HTML.div({ class: "muteEditor", style: "position: sticky; padding-top: " + Config.barEditorHeight + "px;" }, this._channelNameDisplay, this._channelNameInput.input, this._channelDropDown)}

	 __init8() {this._editorHeight = 128}
	 __init9() {this._renderedPitchChannels = 0}
	 __init10() {this._renderedNoiseChannels = 0}
	 __init11() {this._renderedChannelHeight = -1}
	 __init12() {this._renderedModChannels = 0}
	 __init13() {this._channelDropDownChannel = 0}
	 __init14() {this._channelDropDownOpen = false}
	 __init15() {this._channelDropDownLastState = false}

	constructor( _doc,  _editor) {;this._doc = _doc;this._editor = _editor;MuteEditor.prototype.__init.call(this);MuteEditor.prototype.__init2.call(this);MuteEditor.prototype.__init3.call(this);MuteEditor.prototype.__init4.call(this);MuteEditor.prototype.__init5.call(this);MuteEditor.prototype.__init6.call(this);MuteEditor.prototype.__init7.call(this);MuteEditor.prototype.__init8.call(this);MuteEditor.prototype.__init9.call(this);MuteEditor.prototype.__init10.call(this);MuteEditor.prototype.__init11.call(this);MuteEditor.prototype.__init12.call(this);MuteEditor.prototype.__init13.call(this);MuteEditor.prototype.__init14.call(this);MuteEditor.prototype.__init15.call(this);MuteEditor.prototype.__init16.call(this);MuteEditor.prototype.__init17.call(this);MuteEditor.prototype.__init18.call(this);MuteEditor.prototype.__init19.call(this);MuteEditor.prototype.__init20.call(this);MuteEditor.prototype.__init21.call(this);MuteEditor.prototype.__init22.call(this);MuteEditor.prototype.__init23.call(this);MuteEditor.prototype.__init24.call(this);MuteEditor.prototype.__init25.call(this);
	 ...
	 __init16() {this._channelNameInputWhenInput = () => {
	 ...
	 __init17() {this._channelNameInputClicked = (event) => {
		event.stopPropagation();
	}}

	 __init18() {this._channelNameInputHide = () => {
		this._channelNameInput.input.style.setProperty("display", "none");
		this._channelNameDisplay.style.setProperty("display", "none");
	}}

	 __init19() {this._channelDropDownClick = (event) => {
	 ...
	 __init20() {this._channelDropDownBlur = () => {
		this._channelDropDownOpen = false;
		this._channelNameDisplay.style.setProperty("display", "none");
		//console.log("blur " + this._channelDropDownOpen);
	}}

	 __init21() {this._channelDropDownGetOpenedPosition = (event) => {
	 ...
	 __init22() {this._channelDropDownHandler = (event) => {
		this._channelNameDisplay.style.setProperty("display", "none");
	 ...
	 __init24() {this._onMouseMove = (event) => {
		const index = this._buttons.indexOf(event.target);
		if (index == -1) {
	 ...
	 __init25() {this._onMouseLeave = (event) => {
		if (!this._channelDropDownOpen) {
			this._channelNameDisplay.style.setProperty("display", "none");
			this._channelDropDown.style.setProperty("width", "0px");
		}
