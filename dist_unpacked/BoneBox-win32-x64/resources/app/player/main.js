...
ColorConfig.setTheme(window.localStorage.getItem("colorTheme") || "bonebox classic");
...
// When compiling synth.ts as a standalone module named "beepbox", expose these classes as members to JavaScript:
	export { EnvelopeType, InstrumentType, Config, Note, Pattern, Instrument, Channel, Synth } ;
