...
import { FilterType, InstrumentType, EffectType, Config, effectsIncludeDistortion } from "../synth/SynthConfig.js";
import { Note, makeNotePin, Pattern, FilterControlPoint, Instrument, Channel, Synth } from "../synth/synth.js";
...
export function generateScaleMap(oldScaleFlags, newScaleValue) {
    ...
    let bestIndexMap = [];
    const stack = [[0]]; // Root always maps to root.
...
class ChangePins extends UndoableChange {
    ...
    constructor( _doc,  _note) {
        super(false);this._doc = _doc;this._note = _note;;
    ...
    constructor(doc) {
        ...
        class PotentialFilterPoint {
            constructor(
                  ...
                  centerHz,
                  centerGain,
            ) {;this.chance = chance;this.type = type;this.minFreq = minFreq;this.maxFreq = maxFreq;this.centerHz = centerHz;this.centerGain = centerGain; }
        }
...
export class ChangeFilterAddPoint extends UndoableChange {
     ...
     __init() {this._envelopeTargetsAdd = []}
     __init2() {this._envelopeIndicesAdd = []}
     __init3() {this._envelopeTargetsRemove = []}
     __init4() {this._envelopeIndicesRemove = []}
    constructor(doc, filterSettings, point, index, isNoteFilter, deletion = false) {
        super(deletion);ChangeFilterAddPoint.prototype.__init.call(this);ChangeFilterAddPoint.prototype.__init2.call(this);ChangeFilterAddPoint.prototype.__init3.call(this);ChangeFilterAddPoint.prototype.__init4.call(this);;
        this._doc = doc;
        this._instrument = this._doc.song.channels[this._doc.channel].instruments[this._doc.getCurrentInstrument()];
...
export class ChangeOperatorAmplitude extends ChangeInstrumentSlider {
     __init5() {this.operatorIndex = 0}
    constructor(doc, operatorIndex, oldValue, newValue) {
        super(doc);ChangeOperatorAmplitude.prototype.__init5.call(this);;
...
export class ChangeLoop extends Change {
    constructor( _doc,  oldStart,  oldLength,  newStart,  newLength) {
        super();this._doc = _doc;this.oldStart = oldStart;this.oldLength = oldLength;this.newStart = newStart;this.newLength = newLength;;
...
export class ChangeEnsurePatternExists extends UndoableChange {
     ...
     __init6() {this._patternOldNotes = null}
    
    
     __init7() {this._oldPatternInstruments = null}
    

    constructor(doc, channelIndex, bar) {
        super(false);ChangeEnsurePatternExists.prototype.__init6.call(this);ChangeEnsurePatternExists.prototype.__init7.call(this);;
        const song = doc.song;
