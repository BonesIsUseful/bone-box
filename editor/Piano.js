...
export class Piano {
		  __init() {this._pianoContainer = HTML.div({style: "width: 100%; height: 100%; display: flex; flex-direction: column-reverse; align-items: stretch;"})}
		  __init2() {this._drumContainer = HTML.div({style: "width: 100%; height: 100%; display: flex; flex-direction: column-reverse; align-items: stretch;"})}
		  __init3() {this._modContainer = HTML.div({ style: "width: 100%; height: 100%; display: flex; flex-direction: column-reverse; align-items: stretch;" })}
		  __init4() {this._preview = HTML.div({style: `width: 100%; height: 40px; border: 2px solid ${ColorConfig.primaryText}; position: absolute; box-sizing: border-box; pointer-events: none;`})}
		  __init5() {this.container = HTML.div({style: "width: 32px; height: 100%; overflow: hidden; position: relative; flex-shrink: 0; touch-action: none;"},
		this._pianoContainer,
		this._drumContainer,
		this._modContainer,
		this._preview,
	)}
	  __init6() {this._editorHeight = 481}
	  __init7() {this._pianoKeys = []}
	  __init8() {this._pianoLabels = []}
	  __init9() {this._modFirstLabels = []}
	  __init10() {this._modSecondLabels = []}
	  __init11() {this._modCountLabels = []}
	  __init12() {this._modCountRects = []}
		
	
	
	//private _mouseX: number = 0;
	 __init13() {this._mouseY = 0}
	 __init14() {this._mouseDown = false}
	 __init15() {this._mouseOver = false}
	
	 __init16() {this._playedPitch = -1}
	 __init17() {this._renderedScale = -1}
	 __init18() {this._renderedDrums = false}
	 __init19() {this._renderedMod = false}
	 __init20() {this._renderedKey = -1}
	 __init21() {this._renderedPitchCount = -1}
	  __init22() {this._renderedLiveInputPitches = []}
	...
	constructor( _doc) {;this._doc = _doc;Piano.prototype.__init.call(this);Piano.prototype.__init2.call(this);Piano.prototype.__init3.call(this);Piano.prototype.__init4.call(this);Piano.prototype.__init5.call(this);Piano.prototype.__init6.call(this);Piano.prototype.__init7.call(this);Piano.prototype.__init8.call(this);Piano.prototype.__init9.call(this);Piano.prototype.__init10.call(this);Piano.prototype.__init11.call(this);Piano.prototype.__init12.call(this);Piano.prototype.__init13.call(this);Piano.prototype.__init14.call(this);Piano.prototype.__init15.call(this);Piano.prototype.__init16.call(this);Piano.prototype.__init17.call(this);Piano.prototype.__init18.call(this);Piano.prototype.__init19.call(this);Piano.prototype.__init20.call(this);Piano.prototype.__init21.call(this);Piano.prototype.__init22.call(this);Piano.prototype.__init23.call(this);Piano.prototype.__init24.call(this);Piano.prototype.__init25.call(this);Piano.prototype.__init26.call(this);Piano.prototype.__init27.call(this);Piano.prototype.__init28.call(this);Piano.prototype.__init29.call(this);Piano.prototype.__init30.call(this);Piano.prototype.__init31.call(this);Piano.prototype.__init32.call(this);
	 ...
	 __init23() {this._whenMouseOver = (event) => {
		if (this._mouseOver) return;
		this._mouseOver = true;
		this._updatePreview();
	}}
		
	 __init24() {this._whenMouseOut = (event) => {
		if (!this._mouseOver) return;
		this._mouseOver = false;
		this._updatePreview();
	}}
		
	 __init25() {this._whenMousePressed = (event) => {
	 ...
	 __init26() {this._whenMouseMoved = (event) => {
	 ...
	 __init27() {this._whenMouseReleased = (event) => {
		if (this._mouseDown) this._releaseLiveInput();
		this._mouseDown = false;
		this._updatePreview();
	}}
		
	 __init28() {this._whenTouchPressed = (event) => {
		event.preventDefault();
		this._doc.synth.maintainLiveInput();
		this._mouseDown = true;
		const boundingRect = this.container.getBoundingClientRect();
	 ...
	 __init29() {this._whenTouchMoved = (event) => {
		event.preventDefault();
		this._doc.synth.maintainLiveInput();
		const boundingRect = this.container.getBoundingClientRect();
		//this._mouseX = event.touches[0].clientX - boundingRect.left;
	 ...
	 __init30() {this._whenTouchReleased = (event) => {
		event.preventDefault();
		this._mouseDown = false;
		this._releaseLiveInput();
	}}
	
	 __init31() {this._onAnimationFrame = () => {
		window.requestAnimationFrame(this._onAnimationFrame);
	 ...
	 __init32() {this._documentChanged = () => {
