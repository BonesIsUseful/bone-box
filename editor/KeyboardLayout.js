...
export class KeyboardLayout {
	 static __initStatic() {this._pianoAtC = [
	 ...
	 static __initStatic2() {this._pianoAtA = [
	 ...
	 __init() {this._possiblyPlayingPitchesFromKeyboard = false}
	
	constructor( _doc) {;this._doc = _doc;KeyboardLayout.prototype.__init.call(this);KeyboardLayout.prototype.__init2.call(this);
		window.addEventListener("blur", this._onWindowBlur);
	}
	
	 __init2() {this._onWindowBlur = (event) => {
...
} KeyboardLayout.__initStatic(); KeyboardLayout.__initStatic2();
