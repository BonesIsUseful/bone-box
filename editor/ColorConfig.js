...
import { toNameMap, Config } from "../synth/SynthConfig.js";
...
export class ColorConfig {
     static __initStatic() {this.colorLookup = new Map()}
	 static __initStatic2() {this.usesColorFormula = false}
     static  __initStatic3() {this.themes = {
        "dark classic": `
			:root {
				--page-margin: black;
	...
	`,
     ...
     static  __initStatic4() {this.pageMargin = "var(--page-margin)"}
     static  __initStatic5() {this.editorBackground = "var(--editor-background)"}
     static  __initStatic6() {this.hoverPreview = "var(--hover-preview)"}
     static  __initStatic7() {this.playhead = "var(--playhead)"}
     static  __initStatic8() {this.primaryText = "var(--primary-text)"}
     static  __initStatic9() {this.secondaryText = "var(--secondary-text)"}
     static  __initStatic10() {this.invertedText = "var(--inverted-text)"}
     static  __initStatic11() {this.textSelection = "var(--text-selection)"}
     static  __initStatic12() {this.boxSelectionFill = "var(--box-selection-fill)"}
     static  __initStatic13() {this.loopAccent = "var(--loop-accent)"}
     static  __initStatic14() {this.linkAccent = "var(--link-accent)"}
     static  __initStatic15() {this.uiWidgetBackground = "var(--ui-widget-background)"}
     static  __initStatic16() {this.uiWidgetFocus = "var(--ui-widget-focus)"}
     static  __initStatic17() {this.pitchBackground = "var(--pitch-background)"}
     static  __initStatic18() {this.tonic = "var(--tonic)"}
     static  __initStatic19() {this.fifthNote = "var(--fifth-note)"}
     static  __initStatic20() {this.whitePianoKey = "var(--white-piano-key)"}
     static  __initStatic21() {this.blackPianoKey = "var(--black-piano-key)"}
     static  __initStatic22() {this.useColorFormula = "var(--use-color-formula)"}
     static  __initStatic23() {this.pitchSecondaryChannelHue = "var(--pitch-secondary-channel-hue)"}
     static  __initStatic24() {this.pitchSecondaryChannelHueScale = "var(--pitch-secondary-channel-hue-scale)"}
     static  __initStatic25() {this.pitchSecondaryChannelSat = "var(--pitch-secondary-channel-sat)"}
     static  __initStatic26() {this.pitchSecondaryChannelSatScale = "var(--pitch-secondary-channel-sat-scale)"}
     static  __initStatic27() {this.pitchSecondaryChannelLum = "var(--pitch-secondary-channel-lum)"}
     static  __initStatic28() {this.pitchSecondaryChannelLumScale = "var(--pitch-secondary-channel-lum-scale)"}
     static  __initStatic29() {this.pitchPrimaryChannelHue = "var(--pitch-primary-channel-hue)"}
     static  __initStatic30() {this.pitchPrimaryChannelHueScale = "var(--pitch-primary-channel-hue-scale)"}
     static  __initStatic31() {this.pitchPrimaryChannelSat = "var(--pitch-primary-channel-sat)"}
     static  __initStatic32() {this.pitchPrimaryChannelSatScale = "var(--pitch-primary-channel-sat-scale)"}
     static  __initStatic33() {this.pitchPrimaryChannelLum = "var(--pitch-primary-channel-lum)"}
     static  __initStatic34() {this.pitchPrimaryChannelLumScale = "var(--pitch-primary-channel-lum-scale)"}
     static  __initStatic35() {this.pitchSecondaryNoteHue = "var(--pitch-secondary-note-hue)"}
     static  __initStatic36() {this.pitchSecondaryNoteHueScale = "var(--pitch-secondary-note-hue-scale)"}
     static  __initStatic37() {this.pitchSecondaryNoteSat = "var(--pitch-secondary-note-sat)"}
     static  __initStatic38() {this.pitchSecondaryNoteSatScale = "var(--pitch-secondary-note-sat-scale)"}
     static  __initStatic39() {this.pitchSecondaryNoteLum = "var(--pitch-secondary-note-lum)"}
     static  __initStatic40() {this.pitchSecondaryNoteLumScale = "var(--pitch-secondary-note-lum-scale)"}
     static  __initStatic41() {this.pitchPrimaryNoteHue = "var(--pitch-primary-note-hue)"}
     static  __initStatic42() {this.pitchPrimaryNoteHueScale = "var(--pitch-primary-note-hue-scale)"}
     static  __initStatic43() {this.pitchPrimaryNoteSat = "var(--pitch-primary-note-sat)"}
     static  __initStatic44() {this.pitchPrimaryNoteSatScale = "var(--pitch-primary-note-sat-scale)"}
     static  __initStatic45() {this.pitchPrimaryNoteLum = "var(--pitch-primary-note-lum)"}
     static  __initStatic46() {this.pitchPrimaryNoteLumScale = "var(--pitch-primary-note-lum-scale)"}
     static  __initStatic47() {this.modSecondaryChannelHue = "var(--mod-secondary-channel-hue)"}
     static  __initStatic48() {this.modSecondaryChannelHueScale = "var(--mod-secondary-channel-hue-scale)"}
     static  __initStatic49() {this.modSecondaryChannelSat = "var(--mod-secondary-channel-sat)"}
     static  __initStatic50() {this.modSecondaryChannelSatScale = "var(--mod-secondary-channel-sat-scale)"}
     static  __initStatic51() {this.modSecondaryChannelLum = "var(--mod-secondary-channel-lum)"}
     static  __initStatic52() {this.modSecondaryChannelLumScale = "var(--mod-secondary-channel-lum-scale)"}
     static  __initStatic53() {this.modPrimaryChannelHue = "var(--mod-primary-channel-hue)"}
     static  __initStatic54() {this.modPrimaryChannelHueScale = "var(--mod-primary-channel-hue-scale)"}
     static  __initStatic55() {this.modPrimaryChannelSat = "var(--mod-primary-channel-sat)"}
     static  __initStatic56() {this.modPrimaryChannelSatScale = "var(--mod-primary-channel-sat-scale)"}
     static  __initStatic57() {this.modPrimaryChannelLum = "var(--mod-primary-channel-lum)"}
     static  __initStatic58() {this.modPrimaryChannelLumScale = "var(--mod-primary-channel-lum-scale)"}
     static  __initStatic59() {this.modSecondaryNoteHue = "var(--mod-secondary-note-hue)"}
     static  __initStatic60() {this.modSecondaryNoteHueScale = "var(--mod-secondary-note-hue-scale)"}
     static  __initStatic61() {this.modSecondaryNoteSat = "var(--mod-secondary-note-sat)"}
     static  __initStatic62() {this.modSecondaryNoteSatScale = "var(--mod-secondary-note-sat-scale)"}
     static  __initStatic63() {this.modSecondaryNoteLum = "var(--mod-secondary-note-lum)"}
     static  __initStatic64() {this.modSecondaryNoteLumScale = "var(--mod-secondary-note-lum-scale)"}
     static  __initStatic65() {this.modPrimaryNoteHue = "var(--mod-primary-note-hue)"}
     static  __initStatic66() {this.modPrimaryNoteHueScale = "var(--mod-primary-note-hue-scale)"}
     static  __initStatic67() {this.modPrimaryNoteSat = "var(--mod-primary-note-sat)"}
     static  __initStatic68() {this.modPrimaryNoteSatScale = "var(--mod-primary-note-sat-scale)"}
     static  __initStatic69() {this.modPrimaryNoteLum = "var(--mod-primary-note-lum)"}
     static  __initStatic70() {this.modPrimaryNoteLumScale = "var(--mod-primary-note-lum-scale)"}
     static  __initStatic71() {this.noiseSecondaryChannelHue = "var(--noise-secondary-channel-hue)"}
     static  __initStatic72() {this.noiseSecondaryChannelHueScale = "var(--noise-secondary-channel-hue-scale)"}
     static  __initStatic73() {this.noiseSecondaryChannelSat = "var(--noise-secondary-channel-sat)"}
     static  __initStatic74() {this.noiseSecondaryChannelSatScale = "var(--noise-secondary-channel-sat-scale)"}
     static  __initStatic75() {this.noiseSecondaryChannelLum = "var(--noise-secondary-channel-lum)"}
     static  __initStatic76() {this.noiseSecondaryChannelLumScale = "var(--noise-secondary-channel-lum-scale)"}
     static  __initStatic77() {this.noisePrimaryChannelHue = "var(--noise-primary-channel-hue)"}
     static  __initStatic78() {this.noisePrimaryChannelHueScale = "var(--noise-primary-channel-hue-scale)"}
     static  __initStatic79() {this.noisePrimaryChannelSat = "var(--noise-primary-channel-sat)"}
     static  __initStatic80() {this.noisePrimaryChannelSatScale = "var(--noise-primary-channel-sat-scale)"}
     static  __initStatic81() {this.noisePrimaryChannelLum = "var(--noise-primary-channel-lum)"}
     static  __initStatic82() {this.noisePrimaryChannelLumScale = "var(--noise-primary-channel-lum-scale)"}
     static  __initStatic83() {this.noiseSecondaryNoteHue = "var(--noise-secondary-note-hue)"}
     static  __initStatic84() {this.noiseSecondaryNoteHueScale = "var(--noise-secondary-note-hue-scale)"}
     static  __initStatic85() {this.noiseSecondaryNoteSat = "var(--noise-secondary-note-sat)"}
     static  __initStatic86() {this.noiseSecondaryNoteSatScale = "var(--noise-secondary-note-sat-scale)"}
     static  __initStatic87() {this.noiseSecondaryNoteLum = "var(--noise-secondary-note-lum)"}
     static  __initStatic88() {this.noiseSecondaryNoteLumScale = "var(--noise-secondary-note-lum-scale)"}
     static  __initStatic89() {this.noisePrimaryNoteHue = "var(--noise-primary-note-hue)"}
     static  __initStatic90() {this.noisePrimaryNoteHueScale = "var(--noise-primary-note-hue-scale)"}
     static  __initStatic91() {this.noisePrimaryNoteSat = "var(--noise-primary-note-sat)"}
     static  __initStatic92() {this.noisePrimaryNoteSatScale = "var(--noise-primary-note-sat-scale)"}
     static  __initStatic93() {this.noisePrimaryNoteLum = "var(--noise-primary-note-lum)"}
     static  __initStatic94() {this.noisePrimaryNoteLumScale = "var(--noise-primary-note-lum-scale)"}
     static  __initStatic95() {this.trackEditorBgPitch = "var(--track-editor-bg-pitch)"}
     static  __initStatic96() {this.trackEditorBgPitchDim = "var(--track-editor-bg-pitch-dim)"}
     static  __initStatic97() {this.trackEditorBgNoise = "var(--track-editor-bg-noise)"}
     static  __initStatic98() {this.trackEditorBgNoiseDim = "var(--track-editor-bg-noise-dim)"}
     static  __initStatic99() {this.trackEditorBgMod = "var(--track-editor-bg-mod)"}
     static  __initStatic100() {this.trackEditorBgModDim = "var(--track-editor-bg-mod-dim)"}
     static  __initStatic101() {this.multiplicativeModSlider = "var(--multiplicative-mod-slider)"}
     static  __initStatic102() {this.overwritingModSlider = "var(--overwriting-mod-slider)"}
     static  __initStatic103() {this.indicatorPrimary = "var(--indicator-primary)"}
     static  __initStatic104() {this.indicatorSecondary = "var(--indicator-secondary)"}
     static  __initStatic105() {this.select2OptGroup = "var(--select2-opt-group)"}
     static  __initStatic106() {this.inputBoxOutline = "var(--input-box-outline)"}
     static  __initStatic107() {this.muteButtonNormal = "var(--mute-button-normal)"}
     static  __initStatic108() {this.muteButtonMod = "var(--mute-button-mod)"}
     static  __initStatic109() {this.modLabelPrimary = "var(--mod-label-primary)"}
     static  __initStatic110() {this.modLabelSecondaryText = "var(--mod-label-secondary-text)"}
     static  __initStatic111() {this.modLabelPrimaryText = "var(--mod-label-primary-text)"}
     static  __initStatic112() {this.disabledNotePrimary = "var(--disabled-note-primary)"}
	 static  __initStatic113() {this.disabledNoteSecondary = "var(--disabled-note-secondary)"}

	 static __initStatic114() {this.c_pitchSecondaryChannelHue = 0}
	 static __initStatic115() {this.c_pitchSecondaryChannelHueScale = 0}
	 static __initStatic116() {this.c_pitchSecondaryChannelSat = 0}
	 static __initStatic117() {this.c_pitchSecondaryChannelSatScale = 0}
	 static __initStatic118() {this.c_pitchSecondaryChannelLum = 0}
	 static __initStatic119() {this.c_pitchSecondaryChannelLumScale = 0}
	 static __initStatic120() {this.c_pitchPrimaryChannelHue = 0}
	 static __initStatic121() {this.c_pitchPrimaryChannelHueScale = 0}
	 static __initStatic122() {this.c_pitchPrimaryChannelSat = 0}
	 static __initStatic123() {this.c_pitchPrimaryChannelSatScale = 0}
	 static __initStatic124() {this.c_pitchPrimaryChannelLum = 0}
	 static __initStatic125() {this.c_pitchPrimaryChannelLumScale = 0}
	 static __initStatic126() {this.c_pitchSecondaryNoteHue = 0}
	 static __initStatic127() {this.c_pitchSecondaryNoteHueScale = 0}
	 static __initStatic128() {this.c_pitchSecondaryNoteSat = 0}
	 static __initStatic129() {this.c_pitchSecondaryNoteSatScale = 0}
	 static __initStatic130() {this.c_pitchSecondaryNoteLum = 0}
	 static __initStatic131() {this.c_pitchSecondaryNoteLumScale = 0}
	 static __initStatic132() {this.c_pitchPrimaryNoteHue = 0}
	 static __initStatic133() {this.c_pitchPrimaryNoteHueScale = 0}
	 static __initStatic134() {this.c_pitchPrimaryNoteSat = 0}
	 static __initStatic135() {this.c_pitchPrimaryNoteSatScale = 0}
	 static __initStatic136() {this.c_pitchPrimaryNoteLum = 0}
	 static __initStatic137() {this.c_pitchPrimaryNoteLumScale = 0}
	 static __initStatic138() {this.c_modSecondaryChannelHue = 0}
	 static __initStatic139() {this.c_modSecondaryChannelHueScale = 0}
	 static __initStatic140() {this.c_modSecondaryChannelSat = 0}
	 static __initStatic141() {this.c_modSecondaryChannelSatScale = 0}
	 static __initStatic142() {this.c_modSecondaryChannelLum = 0}
	 static __initStatic143() {this.c_modSecondaryChannelLumScale = 0}
	 static __initStatic144() {this.c_modPrimaryChannelHue = 0}
	 static __initStatic145() {this.c_modPrimaryChannelHueScale = 0}
	 static __initStatic146() {this.c_modPrimaryChannelSat = 0}
	 static __initStatic147() {this.c_modPrimaryChannelSatScale = 0}
	 static __initStatic148() {this.c_modPrimaryChannelLum = 0}
	 static __initStatic149() {this.c_modPrimaryChannelLumScale = 0}
	 static __initStatic150() {this.c_modSecondaryNoteHue = 0}
	 static __initStatic151() {this.c_modSecondaryNoteHueScale = 0}
	 static __initStatic152() {this.c_modSecondaryNoteSat = 0}
	 static __initStatic153() {this.c_modSecondaryNoteSatScale = 0}
	 static __initStatic154() {this.c_modSecondaryNoteLum = 0}
	 static __initStatic155() {this.c_modSecondaryNoteLumScale = 0}
	 static __initStatic156() {this.c_modPrimaryNoteHue = 0}
	 static __initStatic157() {this.c_modPrimaryNoteHueScale = 0}
	 static __initStatic158() {this.c_modPrimaryNoteSat = 0}
	 static __initStatic159() {this.c_modPrimaryNoteSatScale = 0}
	 static __initStatic160() {this.c_modPrimaryNoteLum = 0}
	 static __initStatic161() {this.c_modPrimaryNoteLumScale = 0}
	 static __initStatic162() {this.c_noiseSecondaryChannelHue = 0}
	 static __initStatic163() {this.c_noiseSecondaryChannelHueScale = 0}
	 static __initStatic164() {this.c_noiseSecondaryChannelSat = 0}
	 static __initStatic165() {this.c_noiseSecondaryChannelSatScale = 0}
	 static __initStatic166() {this.c_noiseSecondaryChannelLum = 0}
	 static __initStatic167() {this.c_noiseSecondaryChannelLumScale = 0}
	 static __initStatic168() {this.c_noisePrimaryChannelHue = 0}
	 static __initStatic169() {this.c_noisePrimaryChannelHueScale = 0}
	 static __initStatic170() {this.c_noisePrimaryChannelSat = 0}
	 static __initStatic171() {this.c_noisePrimaryChannelSatScale = 0}
	 static __initStatic172() {this.c_noisePrimaryChannelLum = 0}
	 static __initStatic173() {this.c_noisePrimaryChannelLumScale = 0}
	 static __initStatic174() {this.c_noiseSecondaryNoteHue = 0}
	 static __initStatic175() {this.c_noiseSecondaryNoteHueScale = 0}
	 static __initStatic176() {this.c_noiseSecondaryNoteSat = 0}
	 static __initStatic177() {this.c_noiseSecondaryNoteSatScale = 0}
	 static __initStatic178() {this.c_noiseSecondaryNoteLum = 0}
	 static __initStatic179() {this.c_noiseSecondaryNoteLumScale = 0}
	 static __initStatic180() {this.c_noisePrimaryNoteHue = 0}
	 static __initStatic181() {this.c_noisePrimaryNoteHueScale = 0}
	 static __initStatic182() {this.c_noisePrimaryNoteSat = 0}
	 static __initStatic183() {this.c_noisePrimaryNoteSatScale = 0}
	 static __initStatic184() {this.c_noisePrimaryNoteLum = 0}
	 static __initStatic185() {this.c_noisePrimaryNoteLumScale = 0}

	 static __initStatic186() {this.c_invertedText = ""}
	 static __initStatic187() {this.c_trackEditorBgNoiseDim = ""}
	 static __initStatic188() {this.c_trackEditorBgNoise = ""}
	 static __initStatic189() {this.c_trackEditorBgModDim = ""}
	 static __initStatic190() {this.c_trackEditorBgMod = ""}
	 static __initStatic191() {this.c_trackEditorBgPitchDim = ""}
	 static __initStatic192() {this.c_trackEditorBgPitch = ""}


     static  __initStatic193() {this.pitchChannels = toNameMap([
        {
            name: "pitch1", // cyan
     ...
     static  __initStatic194() {this.noiseChannels = toNameMap([
        {
            name: "noise1", // gray
     ...
     static  __initStatic195() {this.modChannels = toNameMap([
        {
            name: "mod1",
    ...
    // Same as below, but won't return var colors
     ...
     static  __initStatic196() {this._styleElement = document.head.appendChild(HTML.style({ type: "text/css" }))}

     static setTheme(name) {
		let theme = this.themes[name];
		if (theme == undefined) theme = this.themes["bonebox classic"];
     ...
     static loopRegionTintLayer() {
        return `linear-gradient(color-mix(in srgb, ${ColorConfig.loopAccent} 8%, transparent), color-mix(in srgb, ${ColorConfig.loopAccent} 8%, transparent))`;
    }
} ColorConfig.__initStatic(); ColorConfig.__initStatic2(); ColorConfig.__initStatic3(); ColorConfig.__initStatic4(); ColorConfig.__initStatic5(); ColorConfig.__initStatic6(); ColorConfig.__initStatic7(); ColorConfig.__initStatic8(); ColorConfig.__initStatic9(); ColorConfig.__initStatic10(); ColorConfig.__initStatic11(); ColorConfig.__initStatic12(); ColorConfig.__initStatic13(); ColorConfig.__initStatic14(); ColorConfig.__initStatic15(); ColorConfig.__initStatic16(); ColorConfig.__initStatic17(); ColorConfig.__initStatic18(); ColorConfig.__initStatic19(); ColorConfig.__initStatic20(); ColorConfig.__initStatic21(); ColorConfig.__initStatic22(); ColorConfig.__initStatic23(); ColorConfig.__initStatic24(); ColorConfig.__initStatic25(); ColorConfig.__initStatic26(); ColorConfig.__initStatic27(); ColorConfig.__initStatic28(); ColorConfig.__initStatic29(); ColorConfig.__initStatic30(); ColorConfig.__initStatic31(); ColorConfig.__initStatic32(); ColorConfig.__initStatic33(); ColorConfig.__initStatic34(); ColorConfig.__initStatic35(); ColorConfig.__initStatic36(); ColorConfig.__initStatic37(); ColorConfig.__initStatic38(); ColorConfig.__initStatic39(); ColorConfig.__initStatic40(); ColorConfig.__initStatic41(); ColorConfig.__initStatic42(); ColorConfig.__initStatic43(); ColorConfig.__initStatic44(); ColorConfig.__initStatic45(); ColorConfig.__initStatic46(); ColorConfig.__initStatic47(); ColorConfig.__initStatic48(); ColorConfig.__initStatic49(); ColorConfig.__initStatic50(); ColorConfig.__initStatic51(); ColorConfig.__initStatic52(); ColorConfig.__initStatic53(); ColorConfig.__initStatic54(); ColorConfig.__initStatic55(); ColorConfig.__initStatic56(); ColorConfig.__initStatic57(); ColorConfig.__initStatic58(); ColorConfig.__initStatic59(); ColorConfig.__initStatic60(); ColorConfig.__initStatic61(); ColorConfig.__initStatic62(); ColorConfig.__initStatic63(); ColorConfig.__initStatic64(); ColorConfig.__initStatic65(); ColorConfig.__initStatic66(); ColorConfig.__initStatic67(); ColorConfig.__initStatic68(); ColorConfig.__initStatic69(); ColorConfig.__initStatic70(); ColorConfig.__initStatic71(); ColorConfig.__initStatic72(); ColorConfig.__initStatic73(); ColorConfig.__initStatic74(); ColorConfig.__initStatic75(); ColorConfig.__initStatic76(); ColorConfig.__initStatic77(); ColorConfig.__initStatic78(); ColorConfig.__initStatic79(); ColorConfig.__initStatic80(); ColorConfig.__initStatic81(); ColorConfig.__initStatic82(); ColorConfig.__initStatic83(); ColorConfig.__initStatic84(); ColorConfig.__initStatic85(); ColorConfig.__initStatic86(); ColorConfig.__initStatic87(); ColorConfig.__initStatic88(); ColorConfig.__initStatic89(); ColorConfig.__initStatic90(); ColorConfig.__initStatic91(); ColorConfig.__initStatic92(); ColorConfig.__initStatic93(); ColorConfig.__initStatic94(); ColorConfig.__initStatic95(); ColorConfig.__initStatic96(); ColorConfig.__initStatic97(); ColorConfig.__initStatic98(); ColorConfig.__initStatic99(); ColorConfig.__initStatic100(); ColorConfig.__initStatic101(); ColorConfig.__initStatic102(); ColorConfig.__initStatic103(); ColorConfig.__initStatic104(); ColorConfig.__initStatic105(); ColorConfig.__initStatic106(); ColorConfig.__initStatic107(); ColorConfig.__initStatic108(); ColorConfig.__initStatic109(); ColorConfig.__initStatic110(); ColorConfig.__initStatic111(); ColorConfig.__initStatic112(); ColorConfig.__initStatic113(); ColorConfig.__initStatic114(); ColorConfig.__initStatic115(); ColorConfig.__initStatic116(); ColorConfig.__initStatic117(); ColorConfig.__initStatic118(); ColorConfig.__initStatic119(); ColorConfig.__initStatic120(); ColorConfig.__initStatic121(); ColorConfig.__initStatic122(); ColorConfig.__initStatic123(); ColorConfig.__initStatic124(); ColorConfig.__initStatic125(); ColorConfig.__initStatic126(); ColorConfig.__initStatic127(); ColorConfig.__initStatic128(); ColorConfig.__initStatic129(); ColorConfig.__initStatic130(); ColorConfig.__initStatic131(); ColorConfig.__initStatic132(); ColorConfig.__initStatic133(); ColorConfig.__initStatic134(); ColorConfig.__initStatic135(); ColorConfig.__initStatic136(); ColorConfig.__initStatic137(); ColorConfig.__initStatic138(); ColorConfig.__initStatic139(); ColorConfig.__initStatic140(); ColorConfig.__initStatic141(); ColorConfig.__initStatic142(); ColorConfig.__initStatic143(); ColorConfig.__initStatic144(); ColorConfig.__initStatic145(); ColorConfig.__initStatic146(); ColorConfig.__initStatic147(); ColorConfig.__initStatic148(); ColorConfig.__initStatic149(); ColorConfig.__initStatic150(); ColorConfig.__initStatic151(); ColorConfig.__initStatic152(); ColorConfig.__initStatic153(); ColorConfig.__initStatic154(); ColorConfig.__initStatic155(); ColorConfig.__initStatic156(); ColorConfig.__initStatic157(); ColorConfig.__initStatic158(); ColorConfig.__initStatic159(); ColorConfig.__initStatic160(); ColorConfig.__initStatic161(); ColorConfig.__initStatic162(); ColorConfig.__initStatic163(); ColorConfig.__initStatic164(); ColorConfig.__initStatic165(); ColorConfig.__initStatic166(); ColorConfig.__initStatic167(); ColorConfig.__initStatic168(); ColorConfig.__initStatic169(); ColorConfig.__initStatic170(); ColorConfig.__initStatic171(); ColorConfig.__initStatic172(); ColorConfig.__initStatic173(); ColorConfig.__initStatic174(); ColorConfig.__initStatic175(); ColorConfig.__initStatic176(); ColorConfig.__initStatic177(); ColorConfig.__initStatic178(); ColorConfig.__initStatic179(); ColorConfig.__initStatic180(); ColorConfig.__initStatic181(); ColorConfig.__initStatic182(); ColorConfig.__initStatic183(); ColorConfig.__initStatic184(); ColorConfig.__initStatic185(); ColorConfig.__initStatic186(); ColorConfig.__initStatic187(); ColorConfig.__initStatic188(); ColorConfig.__initStatic189(); ColorConfig.__initStatic190(); ColorConfig.__initStatic191(); ColorConfig.__initStatic192(); ColorConfig.__initStatic193(); ColorConfig.__initStatic194(); ColorConfig.__initStatic195(); ColorConfig.__initStatic196();
