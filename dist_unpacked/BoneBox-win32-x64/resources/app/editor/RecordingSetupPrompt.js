...
export class RecordingSetupPrompt  {
	  __init() {this._keyboardMode = select({style: "width: 100%;"},
	  ...
	  __init2() {this._keyboardLayout = select({style: "width: 100%;"},
	  ...
	  __init3() {this._bassOffset = select({style: "width: 100%;"},
		option({value: "0"}, "disabled"),
		option({value: "-1"}, "before"),
		option({value: "1"}, "after"),
	)}
	  __init4() {this._keyboardLayoutPreview = div({style: "display: grid; row-gap: 4px; margin: 4px auto; font-size: 10px;"})}
	  __init5() {this._enableMidi = input({style: "width: 2em; margin-left: 1em;", type: "checkbox"})}
	  __init6() {this._showRecordButton = input({style: "width: 2em; margin-left: 1em;", type: "checkbox"})}
	  __init7() {this._snapRecordedNotesToRhythm = input({style: "width: 2em; margin-left: 1em;", type: "checkbox"})}
	  __init8() {this._ignorePerformedNotesNotInScale = input({style: "width: 2em; margin-left: 1em;", type: "checkbox"})}
	  __init9() {this._metronomeCountIn = input({style: "width: 2em; margin-left: 1em;", type: "checkbox"})}
	  __init10() {this._metronomeWhileRecording = input({style: "width: 2em; margin-left: 1em;", type: "checkbox"})}
	
	  __init11() {this._okayButton = button({class: "okayButton", style: "width:45%;"}, "Okay")}
	  __init12() {this._cancelButton = button({class: "cancelButton"})}
	  __init13() {this.container = div({class: "prompt noSelection recordingSetupPrompt", style: "width: 600px; text-align: right; max-height: 90%;"},
		h2({style: "align-self: center;"}, "Note Recording Setup"),
		div({style: "display: grid; overflow-y: auto; overflow-x: hidden; flex-shrink: 1;"},
			p("BoneBox can record notes as you perform them. You can start recording by pressing Ctrl+Space (or " + EditorConfig.ctrlSymbol + "P)."),
			...
			p("If you have a ", a({href: "https://caniuse.com/midi", target: "_blank"}, "compatible browser"), " on a device connected to a MIDI keyboard, you can use it to perform notes in BoneBox! (Or you could buy ", a({href: "https://imitone.com/", target: "_blank"}, "Imitone"), " or ", a({href: "https://vochlea.com/", target: "_blank"}, "Dubler"), " to hum notes into a microphone while wearing headphones!)"),
			...
			p("Recorded notes often overlap such that one note ends after the next note already started. In BoneBox, these notes get split into multiple notes which may sound different when re-played than they did when you were recording. To fix the sound, you can either manually clean up the notes in the pattern editor, or you could try enabling the \"transition type\" effect on the instrument and setting it to \"continue\"."),
	...
	constructor( _doc) {;this._doc = _doc;RecordingSetupPrompt.prototype.__init.call(this);RecordingSetupPrompt.prototype.__init2.call(this);RecordingSetupPrompt.prototype.__init3.call(this);RecordingSetupPrompt.prototype.__init4.call(this);RecordingSetupPrompt.prototype.__init5.call(this);RecordingSetupPrompt.prototype.__init6.call(this);RecordingSetupPrompt.prototype.__init7.call(this);RecordingSetupPrompt.prototype.__init8.call(this);RecordingSetupPrompt.prototype.__init9.call(this);RecordingSetupPrompt.prototype.__init10.call(this);RecordingSetupPrompt.prototype.__init11.call(this);RecordingSetupPrompt.prototype.__init12.call(this);RecordingSetupPrompt.prototype.__init13.call(this);RecordingSetupPrompt.prototype.__init14.call(this);RecordingSetupPrompt.prototype.__init15.call(this);RecordingSetupPrompt.prototype.__init16.call(this);RecordingSetupPrompt.prototype.__init17.call(this);RecordingSetupPrompt.prototype.__init18.call(this);
	 ...
	 __init18() {this._renderKeyboardLayoutPreview = () => {
