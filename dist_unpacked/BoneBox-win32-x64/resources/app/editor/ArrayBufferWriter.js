...
export class ArrayBufferWriter {
	 __init() {this._writeIndex = 0}
	 __init2() {this._fileSize = 0}
	
	
		
	constructor(initialCapacity) {;ArrayBufferWriter.prototype.__init.call(this);ArrayBufferWriter.prototype.__init2.call(this);
