...
import { FilterSettings, FilterControlPoint } from "../synth/synth.js";

import { HTML, SVG } from "imperative-html/dist/esm/elements-strict";
import { ColorConfig } from "./ColorConfig.js";
import { ChangeSequence } from "./Change.js";
import { ChangeFilterAddPoint, ChangeFilterMovePoint, ChangeFilterSettings } from "./changes.js";
import { prettyNumber } from "./EditorConfig.js";

export class FilterEditor {
     __init() {this._editorWidth = 120}
     __init2() {this._editorHeight = 26}
      __init3() {this._responsePath = SVG.path({ fill: ColorConfig.uiWidgetBackground, "pointer-events": "none" })}
    //private readonly _octaves: SVGSVGElement = SVG.svg({"pointer-events": "none", overflow: "visible"});
     __init4() {this._indicators = []}
     __init5() {this._subFilters = []}
     __init6() {this._writingMods = false}
      __init7() {this._controlPointPath = SVG.path({ fill: "currentColor", "pointer-events": "none" })}
      __init8() {this._dottedLinePath = SVG.path({ fill: "none", stroke: "currentColor", "stroke-width": 1, "stroke-dasharray": "3, 2", "pointer-events": "none" })}
      __init9() {this._highlight = SVG.circle({ fill: "white", stroke: "none", "pointer-events": "none", r: 4 })}
      __init10() {this._svg = SVG.svg({ style: `background-color: ${ColorConfig.editorBackground}; touch-action: none;`, width: "100%", height: "100%", viewBox: "0 0 " + this._editorWidth + " " + this._editorHeight, preserveAspectRatio: "none" },
        this._responsePath,
        //this._octaves,
     ...
     __init11() {this.selfUndoSettings = []}
     __init12() {this.selfUndoHistoryPos = 0}
      __init13() {this._label = HTML.div({ style: "position: absolute; bottom: 0; left: 2px; font-size: 8px; line-height: 1; pointer-events: none;" })}

     __init14() {this.coordText = null}
      __init15() {this.container = HTML.div({ class: "filterEditor", style: "height: 100%; position: relative;" },
        this._svg,
        this._label,
    )}
     __init16() {this._pointRadius = 2}

     __init17() {this._useNoteFilter = false}
     __init18() {this._larger = false}
     __init19() {this._touchMode = false}
     __init20() {this._mouseX = 0}
     __init21() {this._mouseY = 0}
     __init22() {this._mouseOver = false}
     __init23() {this._mouseDown = false}
     __init24() {this._mouseDragging = false}
     __init25() {this._addingPoint = false}
     __init26() {this._deletingPoint = false}
     __init27() {this._addedType = FilterType.peak}
     __init28() {this._selectedIndex = 0}
     __init29() {this._freqStart = 0}
     __init30() {this._gainStart = 0}
     __init31() {this._dragChange = null}
     __init32() {this._subfilterIndex = 0}

    
    
     __init33() {this._renderedSelectedIndex = -1}
     __init34() {this._renderedPointCount = -1}
     __init35() {this._renderedPointTypes = -1}
     __init36() {this._renderedPointFreqs = -1}
     __init37() {this._renderedPointGains = -1}
    //private _renderedKey: number = -1;

    constructor( _doc, useNoteFilter = false, larger = false) {;this._doc = _doc;FilterEditor.prototype.__init.call(this);FilterEditor.prototype.__init2.call(this);FilterEditor.prototype.__init3.call(this);FilterEditor.prototype.__init4.call(this);FilterEditor.prototype.__init5.call(this);FilterEditor.prototype.__init6.call(this);FilterEditor.prototype.__init7.call(this);FilterEditor.prototype.__init8.call(this);FilterEditor.prototype.__init9.call(this);FilterEditor.prototype.__init10.call(this);FilterEditor.prototype.__init11.call(this);FilterEditor.prototype.__init12.call(this);FilterEditor.prototype.__init13.call(this);FilterEditor.prototype.__init14.call(this);FilterEditor.prototype.__init15.call(this);FilterEditor.prototype.__init16.call(this);FilterEditor.prototype.__init17.call(this);FilterEditor.prototype.__init18.call(this);FilterEditor.prototype.__init19.call(this);FilterEditor.prototype.__init20.call(this);FilterEditor.prototype.__init21.call(this);FilterEditor.prototype.__init22.call(this);FilterEditor.prototype.__init23.call(this);FilterEditor.prototype.__init24.call(this);FilterEditor.prototype.__init25.call(this);FilterEditor.prototype.__init26.call(this);FilterEditor.prototype.__init27.call(this);FilterEditor.prototype.__init28.call(this);FilterEditor.prototype.__init29.call(this);FilterEditor.prototype.__init30.call(this);FilterEditor.prototype.__init31.call(this);FilterEditor.prototype.__init32.call(this);FilterEditor.prototype.__init33.call(this);FilterEditor.prototype.__init34.call(this);FilterEditor.prototype.__init35.call(this);FilterEditor.prototype.__init36.call(this);FilterEditor.prototype.__init37.call(this);FilterEditor.prototype.__init38.call(this);FilterEditor.prototype.__init39.call(this);FilterEditor.prototype.__init40.call(this);FilterEditor.prototype.__init41.call(this);FilterEditor.prototype.__init42.call(this);FilterEditor.prototype.__init43.call(this);FilterEditor.prototype.__init44.call(this);FilterEditor.prototype.__init45.call(this);
     ...
     __init38() {this._whenKeyPressed = (event) => {
     ...
     __init39() {this._whenMouseOver = (event) => {
     ...
     __init40() {this._whenMouseOut = (event) => {
     ...
     __init41() {this._whenMousePressed = (event) => {
     ...
     __init42() {this._whenTouchPressed = (event) => {
        event.preventDefault();
     ...
     __init44() {this._whenTouchMoved = (event) => {
        if (this.container.offsetParent == null) return;
     ...
     __init45() {this._whenCursorReleased = (event) => {
        if (this._writingMods) {
            const instrument = this._doc.song.channels[this._doc.channel].instruments[this._doc.getCurrentInstrument()];
            this._useFilterSettings = this._getTargetFilterSettings(instrument);
        }
