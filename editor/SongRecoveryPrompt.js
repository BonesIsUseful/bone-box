...
import { SongRecovery, versionToKey } from "./SongRecovery.js";
...
export class SongRecoveryPrompt  {
	  __init() {this._songContainer = div()}
		  __init2() {this._cancelButton = button({class: "cancelButton"})}
		
		  __init3() {this.container = div({class: "prompt", style: "width: 300px;"},
		h2("Song Recovery"),
	...
	constructor( _doc) {;this._doc = _doc;SongRecoveryPrompt.prototype.__init.call(this);SongRecoveryPrompt.prototype.__init2.call(this);SongRecoveryPrompt.prototype.__init3.call(this);SongRecoveryPrompt.prototype.__init4.call(this);SongRecoveryPrompt.prototype.__init5.call(this);
