...
export class ChannelSettingsPrompt  {
		  __init() {this._patternsStepper = input({style: "width: 3em; margin-left: 1em;", type: "number", step: "1"})}
		  __init2() {this._pitchChannelStepper = input({style: "width: 3em; margin-left: 1em;", type: "number", step: "1"})}
		  __init3() {this._drumChannelStepper = input({style: "width: 3em; margin-left: 1em;", type: "number", step: "1"})}
		  __init4() {this._modChannelStepper = input({ style: "width: 3em; margin-left: 1em;", type: "number", step: "1" })}
		  __init5() {this._layeredInstrumentsBox = input({style: "width: 3em; margin-left: 1em;", type: "checkbox"})}
		  __init6() {this._patternInstrumentsBox = input({style: "width: 3em; margin-left: 1em;", type: "checkbox"})}

		  __init7() {this._cancelButton = button({class: "cancelButton"})}
		  __init8() {this._okayButton = button({class: "okayButton", style: "width:45%;"}, "Okay")}
		
	  __init9() {this.container = div({class: "prompt noSelection", style: "width: 250px; text-align: right;"},
		h2("Channel Settings"),
	...
	constructor( _doc) {;this._doc = _doc;ChannelSettingsPrompt.prototype.__init.call(this);ChannelSettingsPrompt.prototype.__init2.call(this);ChannelSettingsPrompt.prototype.__init3.call(this);ChannelSettingsPrompt.prototype.__init4.call(this);ChannelSettingsPrompt.prototype.__init5.call(this);ChannelSettingsPrompt.prototype.__init6.call(this);ChannelSettingsPrompt.prototype.__init7.call(this);ChannelSettingsPrompt.prototype.__init8.call(this);ChannelSettingsPrompt.prototype.__init9.call(this);ChannelSettingsPrompt.prototype.__init10.call(this);ChannelSettingsPrompt.prototype.__init11.call(this);ChannelSettingsPrompt.prototype.__init12.call(this);ChannelSettingsPrompt.prototype.__init13.call(this);ChannelSettingsPrompt.prototype.__init14.call(this);
		...
		this.container.addEventListener("keydown", this._whenKeyPressed);
		 ...
		 __init10() {this._close = () => { 
		this._doc.undo();
	}}
		
		 __init11() {this.cleanUp = () => { 
	 ...
	 __init12() {this._whenKeyPressed = (event) => {
	 ...
	 __init13() {this._validateNumber = (event) => {
