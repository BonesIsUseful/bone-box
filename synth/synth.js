...
var CharCode; (function (CharCode) {
    const SPACE = 32; CharCode[CharCode["SPACE"] = SPACE] = "SPACE";
    const HASH = 35; CharCode[CharCode["HASH"] = HASH] = "HASH";
    const PERCENT = 37; CharCode[CharCode["PERCENT"] = PERCENT] = "PERCENT";
    const AMPERSAND = 38; CharCode[CharCode["AMPERSAND"] = AMPERSAND] = "AMPERSAND";
    const PLUS = 43; CharCode[CharCode["PLUS"] = PLUS] = "PLUS";
    const DASH = 45; CharCode[CharCode["DASH"] = DASH] = "DASH";
    const DOT = 46; CharCode[CharCode["DOT"] = DOT] = "DOT";
    const NUM_0 = 48; CharCode[CharCode["NUM_0"] = NUM_0] = "NUM_0";
    const NUM_1 = 49; CharCode[CharCode["NUM_1"] = NUM_1] = "NUM_1";
    const NUM_2 = 50; CharCode[CharCode["NUM_2"] = NUM_2] = "NUM_2";
    const NUM_3 = 51; CharCode[CharCode["NUM_3"] = NUM_3] = "NUM_3";
    const NUM_4 = 52; CharCode[CharCode["NUM_4"] = NUM_4] = "NUM_4";
    const NUM_5 = 53; CharCode[CharCode["NUM_5"] = NUM_5] = "NUM_5";
    const NUM_6 = 54; CharCode[CharCode["NUM_6"] = NUM_6] = "NUM_6";
    const NUM_7 = 55; CharCode[CharCode["NUM_7"] = NUM_7] = "NUM_7";
    const NUM_8 = 56; CharCode[CharCode["NUM_8"] = NUM_8] = "NUM_8";
    const NUM_9 = 57; CharCode[CharCode["NUM_9"] = NUM_9] = "NUM_9";
    const EQUALS = 61; CharCode[CharCode["EQUALS"] = EQUALS] = "EQUALS";
    const A = 65; CharCode[CharCode["A"] = A] = "A";
    const B = 66; CharCode[CharCode["B"] = B] = "B";
    const C = 67; CharCode[CharCode["C"] = C] = "C";
    const D = 68; CharCode[CharCode["D"] = D] = "D";
    const E = 69; CharCode[CharCode["E"] = E] = "E";
    const F = 70; CharCode[CharCode["F"] = F] = "F";
    const G = 71; CharCode[CharCode["G"] = G] = "G";
    const H = 72; CharCode[CharCode["H"] = H] = "H";
    const I = 73; CharCode[CharCode["I"] = I] = "I";
    const J = 74; CharCode[CharCode["J"] = J] = "J";
    const K = 75; CharCode[CharCode["K"] = K] = "K";
    const L = 76; CharCode[CharCode["L"] = L] = "L";
    const M = 77; CharCode[CharCode["M"] = M] = "M";
    const N = 78; CharCode[CharCode["N"] = N] = "N";
    const O = 79; CharCode[CharCode["O"] = O] = "O";
    const P = 80; CharCode[CharCode["P"] = P] = "P";
    const Q = 81; CharCode[CharCode["Q"] = Q] = "Q";
    const R = 82; CharCode[CharCode["R"] = R] = "R";
    const S = 83; CharCode[CharCode["S"] = S] = "S";
    const T = 84; CharCode[CharCode["T"] = T] = "T";
    const U = 85; CharCode[CharCode["U"] = U] = "U";
    const V = 86; CharCode[CharCode["V"] = V] = "V";
    const W = 87; CharCode[CharCode["W"] = W] = "W";
    const X = 88; CharCode[CharCode["X"] = X] = "X";
    const Y = 89; CharCode[CharCode["Y"] = Y] = "Y";
    const Z = 90; CharCode[CharCode["Z"] = Z] = "Z";
    const UNDERSCORE = 95; CharCode[CharCode["UNDERSCORE"] = UNDERSCORE] = "UNDERSCORE";
    const a = 97; CharCode[CharCode["a"] = a] = "a";
    const b = 98; CharCode[CharCode["b"] = b] = "b";
    const c = 99; CharCode[CharCode["c"] = c] = "c";
    const d = 100; CharCode[CharCode["d"] = d] = "d";
    const e = 101; CharCode[CharCode["e"] = e] = "e";
    const f = 102; CharCode[CharCode["f"] = f] = "f";
    const g = 103; CharCode[CharCode["g"] = g] = "g";
    const h = 104; CharCode[CharCode["h"] = h] = "h";
    const i = 105; CharCode[CharCode["i"] = i] = "i";
    const j = 106; CharCode[CharCode["j"] = j] = "j";
    const k = 107; CharCode[CharCode["k"] = k] = "k";
    const l = 108; CharCode[CharCode["l"] = l] = "l";
    const m = 109; CharCode[CharCode["m"] = m] = "m";
    const n = 110; CharCode[CharCode["n"] = n] = "n";
    const o = 111; CharCode[CharCode["o"] = o] = "o";
    const p = 112; CharCode[CharCode["p"] = p] = "p";
    const q = 113; CharCode[CharCode["q"] = q] = "q";
    const r = 114; CharCode[CharCode["r"] = r] = "r";
    const s = 115; CharCode[CharCode["s"] = s] = "s";
    const t = 116; CharCode[CharCode["t"] = t] = "t";
    const u = 117; CharCode[CharCode["u"] = u] = "u";
    const v = 118; CharCode[CharCode["v"] = v] = "v";
    const w = 119; CharCode[CharCode["w"] = w] = "w";
    const x = 120; CharCode[CharCode["x"] = x] = "x";
    const y = 121; CharCode[CharCode["y"] = y] = "y";
    const z = 122; CharCode[CharCode["z"] = z] = "z";
    const LEFT_CURLY_BRACE = 123; CharCode[CharCode["LEFT_CURLY_BRACE"] = LEFT_CURLY_BRACE] = "LEFT_CURLY_BRACE";
    const RIGHT_CURLY_BRACE = 125; CharCode[CharCode["RIGHT_CURLY_BRACE"] = RIGHT_CURLY_BRACE] = "RIGHT_CURLY_BRACE";
})(CharCode || (CharCode = {}));

var SongTagCode; (function (SongTagCode) {
    const beatCount           = CharCode.a; SongTagCode[SongTagCode["beatCount"] = beatCount] = "beatCount"; // added in BeepBox URL version 2
	const bars                = CharCode.b; SongTagCode[SongTagCode["bars"] = bars] = "bars"; // added in BeepBox URL version 2
	const vibrato             = CharCode.c; SongTagCode[SongTagCode["vibrato"] = vibrato] = "vibrato"; // added in BeepBox URL version 2, DEPRECATED
	const fadeInOut           = CharCode.d; SongTagCode[SongTagCode["fadeInOut"] = fadeInOut] = "fadeInOut"; // added in BeepBox URL version 3 for transition, switched to fadeInOut in 9
	const loopEnd             = CharCode.e; SongTagCode[SongTagCode["loopEnd"] = loopEnd] = "loopEnd"; // added in BeepBox URL version 2
	const eqFilter            = CharCode.f; SongTagCode[SongTagCode["eqFilter"] = eqFilter] = "eqFilter"; // added in BeepBox URL version 3
	const barCount            = CharCode.g; SongTagCode[SongTagCode["barCount"] = barCount] = "barCount"; // added in BeepBox URL version 3
	const unison              = CharCode.h; SongTagCode[SongTagCode["unison"] = unison] = "unison"; // added in BeepBox URL version 2
	const instrumentCount     = CharCode.i; SongTagCode[SongTagCode["instrumentCount"] = instrumentCount] = "instrumentCount"; // added in BeepBox URL version 3
	const patternCount        = CharCode.j; SongTagCode[SongTagCode["patternCount"] = patternCount] = "patternCount"; // added in BeepBox URL version 3
	const key                 = CharCode.k; SongTagCode[SongTagCode["key"] = key] = "key"; // added in BeepBox URL version 2
	const loopStart           = CharCode.l; SongTagCode[SongTagCode["loopStart"] = loopStart] = "loopStart"; // added in BeepBox URL version 2
	const reverb              = CharCode.m; SongTagCode[SongTagCode["reverb"] = reverb] = "reverb"; // added in BeepBox URL version 5, DEPRECATED
	const channelCount        = CharCode.n; SongTagCode[SongTagCode["channelCount"] = channelCount] = "channelCount"; // added in BeepBox URL version 6
	const channelOctave       = CharCode.o; SongTagCode[SongTagCode["channelOctave"] = channelOctave] = "channelOctave"; // added in BeepBox URL version 3
	const patterns            = CharCode.p; SongTagCode[SongTagCode["patterns"] = patterns] = "patterns"; // added in BeepBox URL version 2
	const effects             = CharCode.q; SongTagCode[SongTagCode["effects"] = effects] = "effects"; // added in BeepBox URL version 7
	const rhythm              = CharCode.r; SongTagCode[SongTagCode["rhythm"] = rhythm] = "rhythm"; // added in BeepBox URL version 2
	const scale               = CharCode.s; SongTagCode[SongTagCode["scale"] = scale] = "scale"; // added in BeepBox URL version 2
	const tempo               = CharCode.t; SongTagCode[SongTagCode["tempo"] = tempo] = "tempo"; // added in BeepBox URL version 2
	const preset              = CharCode.u; SongTagCode[SongTagCode["preset"] = preset] = "preset"; // added in BeepBox URL version 7
	const volume              = CharCode.v; SongTagCode[SongTagCode["volume"] = volume] = "volume"; // added in BeepBox URL version 2
	const wave                = CharCode.w; SongTagCode[SongTagCode["wave"] = wave] = "wave"; // added in BeepBox URL version 2
	const supersaw            = CharCode.x; SongTagCode[SongTagCode["supersaw"] = supersaw] = "supersaw"; // added in BeepBox URL version 9
	const filterResonance     = CharCode.y; SongTagCode[SongTagCode["filterResonance"] = filterResonance] = "filterResonance"; // added in BeepBox URL version 7, DEPRECATED
	const drumsetEnvelopes    = CharCode.z; SongTagCode[SongTagCode["drumsetEnvelopes"] = drumsetEnvelopes] = "drumsetEnvelopes"; // added in BeepBox URL version 7 for filter envelopes, still used for drumset envelopes
	const algorithm           = CharCode.A; SongTagCode[SongTagCode["algorithm"] = algorithm] = "algorithm"; // added in BeepBox URL version 6
	const feedbackAmplitude   = CharCode.B; SongTagCode[SongTagCode["feedbackAmplitude"] = feedbackAmplitude] = "feedbackAmplitude"; // added in BeepBox URL version 6
	const chord               = CharCode.C; SongTagCode[SongTagCode["chord"] = chord] = "chord"; // added in BeepBox URL version 7, DEPRECATED
	const detune              = CharCode.D; SongTagCode[SongTagCode["detune"] = detune] = "detune"; // added in BoneBox URL version 3(?) for detune, DEPRECATED
	const envelopes           = CharCode.E; SongTagCode[SongTagCode["envelopes"] = envelopes] = "envelopes"; // added in BeepBox URL version 6 for FM operator envelopes, repurposed in 9 for general envelopes.
	const feedbackType        = CharCode.F; SongTagCode[SongTagCode["feedbackType"] = feedbackType] = "feedbackType"; // added in BeepBox URL version 6
	const arpeggioSpeed       = CharCode.G; SongTagCode[SongTagCode["arpeggioSpeed"] = arpeggioSpeed] = "arpeggioSpeed"; // added in BoneBox URL version 3 for arpeggioSpeed, DEPRECATED
	const harmonics           = CharCode.H; SongTagCode[SongTagCode["harmonics"] = harmonics] = "harmonics"; // added in BeepBox URL version 7
	const stringSustain       = CharCode.I; SongTagCode[SongTagCode["stringSustain"] = stringSustain] = "stringSustain"; // added in BeepBox URL version 9
//	                    = CharCode.J,
//	                    = CharCode.K,
	const pan                 = CharCode.L; SongTagCode[SongTagCode["pan"] = pan] = "pan"; // added between 8 and 9, DEPRECATED
	const customChipWave      = CharCode.M; SongTagCode[SongTagCode["customChipWave"] = customChipWave] = "customChipWave"; // added in BoneBox URL version 1(?) for customChipWave
	const songTitle           = CharCode.N; SongTagCode[SongTagCode["songTitle"] = songTitle] = "songTitle"; // added in BoneBox URL version 1(?) for songTitle
	const limiterSettings     = CharCode.O; SongTagCode[SongTagCode["limiterSettings"] = limiterSettings] = "limiterSettings"; // added in BoneBox URL version 3(?) for limiterSettings
	const operatorAmplitudes  = CharCode.P; SongTagCode[SongTagCode["operatorAmplitudes"] = operatorAmplitudes] = "operatorAmplitudes"; // added in BeepBox URL version 6
	const operatorFrequencies = CharCode.Q; SongTagCode[SongTagCode["operatorFrequencies"] = operatorFrequencies] = "operatorFrequencies"; // added in BeepBox URL version 6
	const operatorWaves       = CharCode.R; SongTagCode[SongTagCode["operatorWaves"] = operatorWaves] = "operatorWaves"; // added in BoneBox URL version 4 for operatorWaves
	const spectrum            = CharCode.S; SongTagCode[SongTagCode["spectrum"] = spectrum] = "spectrum"; // added in BeepBox URL version 7
	const startInstrument     = CharCode.T; SongTagCode[SongTagCode["startInstrument"] = startInstrument] = "startInstrument"; // added in BeepBox URL version 6
	const channelNames        = CharCode.U; SongTagCode[SongTagCode["channelNames"] = channelNames] = "channelNames"; // added in BoneBox URL version 4(?) for channelNames
	const feedbackEnvelope    = CharCode.V; SongTagCode[SongTagCode["feedbackEnvelope"] = feedbackEnvelope] = "feedbackEnvelope"; // added in BeepBox URL version 6, DEPRECATED
	const pulseWidth          = CharCode.W; SongTagCode[SongTagCode["pulseWidth"] = pulseWidth] = "pulseWidth"; // added in BeepBox URL version 7
	const aliases             = CharCode.X; SongTagCode[SongTagCode["aliases"] = aliases] = "aliases"; // added in BoneBox URL version 4 for aliases, DEPRECATED
//	                    = CharCode.Y,
//	                    = CharCode.Z,
//	                    = CharCode.NUM_0,
//	                    = CharCode.NUM_1,
...
class BitFieldReader {
     __init() {this._bits = []}
     __init2() {this._readIndex = 0}

    constructor(source, startIndex, stopIndex) {;BitFieldReader.prototype.__init.call(this);BitFieldReader.prototype.__init2.call(this);
...
class BitFieldWriter {constructor() { BitFieldWriter.prototype.__init3.call(this);BitFieldWriter.prototype.__init4.call(this); }
     __init3() {this._index = 0}
     __init4() {this._bits = []}
...
export class Pattern {constructor() { Pattern.prototype.__init5.call(this);Pattern.prototype.__init6.call(this); }
     __init5() {this.notes = []}
      __init6() {this.instruments = [0]}
...
export class Operator {
     __init7() {this.frequency = 0}
     __init8() {this.amplitude = 0}
     __init9() {this.waveform = 0}
     __init10() {this.pulseWidth = 0.5}

    constructor(index) {;Operator.prototype.__init7.call(this);Operator.prototype.__init8.call(this);Operator.prototype.__init9.call(this);Operator.prototype.__init10.call(this);
        this.reset(index);
    }
...
export class SpectrumWave {
     __init11() {this.spectrum = []}
     __init12() {this.hash = -1}

    constructor(isNoiseChannel) {;SpectrumWave.prototype.__init11.call(this);SpectrumWave.prototype.__init12.call(this);
...
class SpectrumWaveState {constructor() { SpectrumWaveState.prototype.__init13.call(this);SpectrumWaveState.prototype.__init14.call(this); }
     __init13() {this.wave = null}
     __init14() {this._hash = -1}
...
export class HarmonicsWave {
     __init15() {this.harmonics = []}
     __init16() {this.hash = -1}

    constructor() {;HarmonicsWave.prototype.__init15.call(this);HarmonicsWave.prototype.__init16.call(this);
        this.reset();
    }
...
class HarmonicsWaveState {constructor() { HarmonicsWaveState.prototype.__init17.call(this);HarmonicsWaveState.prototype.__init18.call(this); }
     __init17() {this.wave = null}
     __init18() {this._hash = -1}
...
export class FilterControlPoint {constructor() { FilterControlPoint.prototype.__init19.call(this);FilterControlPoint.prototype.__init20.call(this);FilterControlPoint.prototype.__init21.call(this); }
     __init19() {this.freq = 0}
     __init20() {this.gain = Config.filterGainCenter}
     __init21() {this.type = FilterType.peak}
...
export class FilterSettings {
      __init22() {this.controlPoints = []}
     __init23() {this.controlPointCount = 0}

    constructor() {;FilterSettings.prototype.__init22.call(this);FilterSettings.prototype.__init23.call(this);
        this.reset();
    }
    ...
    // Interpolate two FilterSettings, where pos=0 is filterA and pos=1 is filterB
     ...
     convertLegacySettings(legacyCutoffSetting, legacyResonanceSetting, legacyEnv) {
        ...
        // Added for BoneBox - making a 0 point filter does not truncate control points!
...
export class EnvelopeSettings {
     __init24() {this.target = 0}
     __init25() {this.index = 0}
     __init26() {this.envelope = 0}

    constructor() {;EnvelopeSettings.prototype.__init24.call(this);EnvelopeSettings.prototype.__init25.call(this);EnvelopeSettings.prototype.__init26.call(this);
        this.reset();
    }
...
export class Instrument {
     __init27() {this.type = InstrumentType.chip}
     __init28() {this.preset = 0}
     __init29() {this.chipWave = 2}
     __init30() {this.chipNoise = 1}
     __init31() {this.eqFilter = new FilterSettings()}
     __init32() {this.eqFilterType = false}
     __init33() {this.eqFilterSimpleCut = Config.filterSimpleCutRange - 1}
     __init34() {this.eqFilterSimplePeak = 0}
     __init35() {this.noteFilter = new FilterSettings()}
     __init36() {this.noteFilterType = false}
     __init37() {this.noteFilterSimpleCut = Config.filterSimpleCutRange - 1}
     __init38() {this.noteFilterSimplePeak = 0}
     __init39() {this.eqSubFilters = []}
     __init40() {this.noteSubFilters = []}
    
    
    
    
     __init41() {this.envelopes = []}
     __init42() {this.fadeIn = 0}
     __init43() {this.fadeOut = Config.fadeOutNeutral}
     __init44() {this.envelopeCount = 0}
     __init45() {this.transition = Config.transitions.dictionary["normal"].index}
     __init46() {this.pitchShift = 0}
     __init47() {this.detune = 0}
     __init48() {this.vibrato = 0}
     __init49() {this.interval = 0}
     __init50() {this.vibratoDepth = 0}
     __init51() {this.vibratoSpeed = 10}
     __init52() {this.vibratoDelay = 0}
     __init53() {this.vibratoType = 0}
     __init54() {this.envelopeSpeed = 12}
     __init55() {this.discreteEnvelope = false}
     __init56() {this.unison = 0}
     __init57() {this.effects = 0}
     __init58() {this.chord = 1}
     __init59() {this.volume = 0}
     __init60() {this.pan = Config.panCenter}
     __init61() {this.panDelay = 10}
     __init62() {this.arpeggioSpeed = 12}
     __init63() {this.fastTwoNoteArp = false}
     __init64() {this.legacyTieOver = false}
     __init65() {this.clicklessTransition = false}
     __init66() {this.aliases = false}
     __init67() {this.pulseWidth = Config.pulseWidthRange}
     __init68() {this.supersawDynamism = Config.supersawDynamismMax}
	 __init69() {this.supersawSpread = Math.ceil(Config.supersawSpreadMax / 2.0)}
	 __init70() {this.supersawShape = 0}
	 __init71() {this.stringSustain = 10}
	 __init72() {this.stringSustainType = SustainType.acoustic}
     __init73() {this.distortion = 0}
     __init74() {this.bitcrusherFreq = 0}
     __init75() {this.bitcrusherQuantization = 0}
     __init76() {this.chorus = 0}
     __init77() {this.reverb = 0}
     __init78() {this.echoSustain = 0}
     __init79() {this.echoDelay = 0}
     __init80() {this.algorithm = 0}
     __init81() {this.feedbackType = 0}
     __init82() {this.feedbackAmplitude = 0}
     __init83() {this.customChipWave = new Float32Array(64)}
     __init84() {this.customChipWaveIntegral = new Float32Array(65)} // One extra element for wrap-around in chipSynth.
      __init85() {this.operators = []}
    
      __init86() {this.harmonicsWave = new HarmonicsWave()}
      __init87() {this.drumsetEnvelopes = []}
      __init88() {this.drumsetSpectrumWaves = []}
     __init89() {this.modChannels = []}
     __init90() {this.modInstruments = []}
     __init91() {this.modulators = []}
     __init92() {this.modFilterTypes = []}
     __init93() {this.invalidModulators = []}
    constructor(isNoiseChannel, isModChannel) {;Instrument.prototype.__init27.call(this);Instrument.prototype.__init28.call(this);Instrument.prototype.__init29.call(this);Instrument.prototype.__init30.call(this);Instrument.prototype.__init31.call(this);Instrument.prototype.__init32.call(this);Instrument.prototype.__init33.call(this);Instrument.prototype.__init34.call(this);Instrument.prototype.__init35.call(this);Instrument.prototype.__init36.call(this);Instrument.prototype.__init37.call(this);Instrument.prototype.__init38.call(this);Instrument.prototype.__init39.call(this);Instrument.prototype.__init40.call(this);Instrument.prototype.__init41.call(this);Instrument.prototype.__init42.call(this);Instrument.prototype.__init43.call(this);Instrument.prototype.__init44.call(this);Instrument.prototype.__init45.call(this);Instrument.prototype.__init46.call(this);Instrument.prototype.__init47.call(this);Instrument.prototype.__init48.call(this);Instrument.prototype.__init49.call(this);Instrument.prototype.__init50.call(this);Instrument.prototype.__init51.call(this);Instrument.prototype.__init52.call(this);Instrument.prototype.__init53.call(this);Instrument.prototype.__init54.call(this);Instrument.prototype.__init55.call(this);Instrument.prototype.__init56.call(this);Instrument.prototype.__init57.call(this);Instrument.prototype.__init58.call(this);Instrument.prototype.__init59.call(this);Instrument.prototype.__init60.call(this);Instrument.prototype.__init61.call(this);Instrument.prototype.__init62.call(this);Instrument.prototype.__init63.call(this);Instrument.prototype.__init64.call(this);Instrument.prototype.__init65.call(this);Instrument.prototype.__init66.call(this);Instrument.prototype.__init67.call(this);Instrument.prototype.__init68.call(this);Instrument.prototype.__init69.call(this);Instrument.prototype.__init70.call(this);Instrument.prototype.__init71.call(this);Instrument.prototype.__init72.call(this);Instrument.prototype.__init73.call(this);Instrument.prototype.__init74.call(this);Instrument.prototype.__init75.call(this);Instrument.prototype.__init76.call(this);Instrument.prototype.__init77.call(this);Instrument.prototype.__init78.call(this);Instrument.prototype.__init79.call(this);Instrument.prototype.__init80.call(this);Instrument.prototype.__init81.call(this);Instrument.prototype.__init82.call(this);Instrument.prototype.__init83.call(this);Instrument.prototype.__init84.call(this);Instrument.prototype.__init85.call(this);Instrument.prototype.__init86.call(this);Instrument.prototype.__init87.call(this);Instrument.prototype.__init88.call(this);Instrument.prototype.__init89.call(this);Instrument.prototype.__init90.call(this);Instrument.prototype.__init91.call(this);Instrument.prototype.__init92.call(this);Instrument.prototype.__init93.call(this);
    ...
    // (only) difference for BoneBox: Returns whether or not the note filter was chosen for filter conversion.
     ...
     fromJsonObject(instrumentObject, isNoiseChannel, isModChannel, useSlowerRhythm, useFastTwoNoteArp, legacyGlobalReverb = 0) {
		...
		if (this.stringSustainType == -1) this.stringSustainType = SustainType.bright;
...
export class Channel {constructor() { Channel.prototype.__init94.call(this);Channel.prototype.__init95.call(this);Channel.prototype.__init96.call(this);Channel.prototype.__init97.call(this);Channel.prototype.__init98.call(this);Channel.prototype.__init99.call(this); }
     __init94() {this.octave = 0}
      __init95() {this.instruments = []}
      __init96() {this.patterns = []}
      __init97() {this.bars = []}
     __init98() {this.muted = false}
     __init99() {this.name = ""}
}

export class Song {
     static  __initStatic() {this._format = "BoneBox"}
     static  __initStatic2() {this._oldestBeepboxVersion = 2}
     static  __initStatic3() {this._latestBeepboxVersion = 9}
     static  __initStatic4() {this._oldestBoneBoxVersion = 1}
     static  __initStatic5() {this._latestBoneBoxVersion = 6}
    // One-character variant detection at the start of URL to distinguish variants such as BoneBox.
     static  __initStatic6() {this._variant = 0x6A} //"j" ~ bonebox
      ...
      __init100() {this.channels = []}
     __init101() {this.limitDecay = 4.0}
     __init102() {this.limitRise = 4000.0}
     __init103() {this.compressionThreshold = 1.0}
     __init104() {this.limitThreshold = 1.0}
     __init105() {this.compressionRatio = 1.0}
     __init106() {this.limitRatio = 1.0}
     __init107() {this.masterGain = 1.0}
     __init108() {this.inVolumeCap = 0.0}
     __init109() {this.outVolumeCap = 0.0}

    constructor(string) {;Song.prototype.__init100.call(this);Song.prototype.__init101.call(this);Song.prototype.__init102.call(this);Song.prototype.__init103.call(this);Song.prototype.__init104.call(this);Song.prototype.__init105.call(this);Song.prototype.__init106.call(this);Song.prototype.__init107.call(this);Song.prototype.__init108.call(this);Song.prototype.__init109.call(this);Song.prototype.__init110.call(this);Song.prototype.__init111.call(this);Song.prototype.__init112.call(this);
        if (string != undefined) {
    ...
    // Returns the ideal new note volume when dragging (max volume for a normal note, a "neutral" value for mod notes based on how they work)
     __init110() {this.getNewNoteVolume = (isMod, modChannel, modInstrument, modCount) => {
     ...
     __init111() {this.getVolumeCap = (isMod, modChannel, modInstrument, modCount) => {
        if (!isMod || modChannel == undefined || modInstrument == undefined || modCount == undefined)
            return 6;
        else {
            // Sigh, the way pitches count up and the visual ordering in the UI are flipped.
     ...
     __init112() {this.getVolumeCapForSetting = (isMod, modSetting, filterType) => {
        if (!isMod)
     ...
     toBase64String() {
        ...
        buffer.push(base64IntToCharCode[Song._latestBoneBoxVersion]);
        ...
        buffer.push(SongTagCode.instrumentCount, base64IntToCharCode[(this.layeredInstruments << 1) | this.patternInstruments]);
     ...
     fromBase64String(compressed) {
        ...
        if (fromBoneBox && (version == -1 || version > Song._latestBoneBoxVersion || version < Song._oldestBoneBoxVersion)) return;
        ...
        this.initToDefault((fromBeepBox && beforeNine) || (fromBoneBox && beforeFive));
        const forceSimpleFilter = (fromBeepBox && beforeNine || fromBoneBox && beforeFive);
        ...
        if ((fromBeepBox && beforeNine) || (fromBoneBox && beforeFive)) {
        ...
        while (charIndex < compressed.length) switch (command = compressed.charCodeAt(charIndex++)) {
            ...
            case SongTagCode.channelCount: {
                ...
                if (fromBeepBox || beforeTwo) {
                    // No mod channel support before bonebox v2
                    this.modChannelCount = 0;
                } else {
            ...
            case SongTagCode.scale: {
                ...
                // All the scales were jumbled around by BoneBox. Just convert to free.
            ...
            case SongTagCode.reverb: {
                ...
                } else if (beforeFive && fromBoneBox) {
                    legacyGlobalReverb = base64CharCodeToInt[compressed.charCodeAt(charIndex++)];
                    legacyGlobalReverb = clamp(0, Config.reverbRange, legacyGlobalReverb);
                } else {
                    // Do nothing, BeepBox v9+ do not support song-wide reverb - BoneBox still does via modulator.
                }
            } break;
            ...
            case SongTagCode.instrumentCount: {
                if ((beforeNine && fromBeepBox) || (beforeFive && fromBoneBox)) {
            ...
            case SongTagCode.rhythm: {
                ...
                if (fromBoneBox && beforeThree || fromBeepBox) {
            ...
            case SongTagCode.channelOctave: {
                ...
                } else if ((beforeNine && fromBeepBox) || (beforeFive && fromBoneBox)) {
                    for (let channelIndex = 0; channelIndex < this.getChannelCount(); channelIndex++) {
                        this.channels[channelIndex].octave = clamp(0, Config.pitchOctaves, base64CharCodeToInt[compressed.charCodeAt(charIndex++)] + 1);
                        if (channelIndex >= this.pitchChannelCount) this.channels[channelIndex].octave = 0;
                    }
            ...
            case SongTagCode.startInstrument: {
                ...
                // Anti-aliasing was added in BeepBox 3.0 (v6->v7) and BoneBox 1.3 (v1->v2 roughly but some leakage possible)
                if (((beforeSeven && fromBeepBox) || (beforeTwo && fromBoneBox)) && (instrumentType == InstrumentType.chip || instrumentType == InstrumentType.customChipWave || instrumentType == InstrumentType.pwm)) {
            ...
            case SongTagCode.pulseWidth: {
                const instrument = this.channels[instrumentChannelIterator].instruments[instrumentIndexIterator];
                instrument.pulseWidth = clamp(0, Config.pulseWidthRange + (+(fromBoneBox)), base64CharCodeToInt[compressed.charCodeAt(charIndex++)]);
                if (fromBeepBox) {
                    // BeepBox formula
                        ...
                        if (beforeThree && fromBeepBox) {
                            ...
                            for (let channelIndex = 0; channelIndex < this.getChannelCount(); channelIndex++) {
                                for (let i = 0; i < this.channels[channelIndex].instruments.length; i++) {
                                    ...
                                    if ((legacyGlobalReverb != 0 || (fromBoneBox && beforeFive)) && !this.getChannelIsNoise(channelIndex)) {
                            ...
                            if (legacyGlobalReverb != 0 || (fromBoneBox && beforeFive)) {
                                // Enable reverb if it was used globaly before. (Global reverb was added before the effects option so I need to pick somewhere else to initialize instrument reverb, and I picked the vibrato command.)
                                instrument.effects |= 1 << EffectType.reverb;
                                instrument.reverb = legacyGlobalReverb;
                            }
                ...
                if ((beforeNine && fromBeepBox) || (beforeFive && fromBoneBox)) {
                    ...
                    if (effectsIncludeNoteFilter(instrument.effects)) {
                        ...
                        if (fromBeepBox || typeCheck == 0) {
                            ...
                            if (fromBoneBox)
                                typeCheck = base64CharCodeToInt[compressed.charCodeAt(charIndex++)]; // Skip to next index in bonebox to get actual count
                    ...
                    if (effectsIncludeChord(instrument.effects)) {
                        ...
                        if (instrument.chord == Config.chords.dictionary["arpeggio"].index && fromBoneBox) {
                    ...
                    if (effectsIncludeVibrato(instrument.effects)) {
                        ...
                        // Custom vibrato
                        if (instrument.vibrato == Config.vibratos.length && fromBoneBox) {
                    ...
                    if (effectsIncludePanning(instrument.effects)) {
                        if (fromBeepBox) {
                            // Beepbox has a panMax of 8 (9 total positions), BoneBox has a panMax of 100 (101 total positions)
                        ...
                        // Now, pan delay follows on new versions of bonebox.
                        if (fromBoneBox && !beforeTwo)
            ...
            case SongTagCode.volume: {
                if (beforeThree && fromBeepBox) {
                    ...
                    const instrument = this.channels[instrumentChannelIterator].instruments[instrumentIndexIterator];
                    // Volume is stored in two bytes in bonebox just in case range ever exceeds one byte, e.g. through later waffling on the subject.
            ...
            case SongTagCode.detune: {
                ...
                if (fromBoneBox && beforeFive) {
                    // Before bonebox v5, detune was -50 to 50. Now it is 0 to 400
            ...
            case SongTagCode.patterns: {
                ...
                let channelIndex;
                let largerChords = !((beforeFour && fromBoneBox) || fromBeepBox);
                ...
                while (true) {
                    ...
                    for (let j = 0; j < channel.instruments.length; j++) {
                        ...
                        for (let i = 0; i < Config.modCount; i++) {
                            detuneScaleNotes[j][Config.modCount - 1 - i] = 1 + 3 * +(beforeFive && fromBoneBox && isModChannel && (channel.instruments[j].modulators[i] == Config.modulators.dictionary["detune"].index));
                        }
                    }
                ...
                if (fromBoneBox && beforeFive && songReverbIndex >= 0) {
     ...
     toJsonObject(enableIntro = true, loopCount = 1, enableOutro = true) {
        ...
        return {
            "name": this.title,
            "format": Song._format,
            "version": Song._latestBoneBoxVersion,
...
} Song.__initStatic(); Song.__initStatic2(); Song.__initStatic3(); Song.__initStatic4(); Song.__initStatic5(); Song.__initStatic6();

class PickedString {
     __init113() {this.delayLine = null}
     ...
     __init114() {this.allPassG = 0.0}
     __init115() {this.allPassGDelta = 0.0}
    __init116() {this.sustainFilterA1 = 0.0}
	 __init117() {this.sustainFilterA1Delta = 0.0}
	 __init118() {this.sustainFilterA2 = 0.0}
	 __init119() {this.sustainFilterA2Delta = 0.0}
	 __init120() {this.sustainFilterB0 = 0.0}
	 __init121() {this.sustainFilterB0Delta = 0.0}
	 __init122() {this.sustainFilterB1 = 0.0}
	 __init123() {this.sustainFilterB1Delta = 0.0}
	 __init124() {this.sustainFilterB2 = 0.0}
	 __init125() {this.sustainFilterB2Delta = 0.0}

    constructor() {;PickedString.prototype.__init113.call(this);PickedString.prototype.__init114.call(this);PickedString.prototype.__init115.call(this);PickedString.prototype.__init116.call(this);PickedString.prototype.__init117.call(this);PickedString.prototype.__init118.call(this);PickedString.prototype.__init119.call(this);PickedString.prototype.__init120.call(this);PickedString.prototype.__init121.call(this);PickedString.prototype.__init122.call(this);PickedString.prototype.__init123.call(this);PickedString.prototype.__init124.call(this);PickedString.prototype.__init125.call(this);
        this.reset();
    }
     ...
     update(synth, instrumentState, tone, stringIndex, roundedSamplesPerTick, stringDecayStart, stringDecayEnd, sustainType) {
		...
		var PickedStringBrightnessType; (function (PickedStringBrightnessType) {
			const bright = 0; PickedStringBrightnessType[PickedStringBrightnessType["bright"] = bright] = "bright"; // 1st order shelf
			const normal = bright + 1; PickedStringBrightnessType[PickedStringBrightnessType["normal"] = normal] = "normal"; // 2nd order lowpass, rounded corner
			const resonant = normal + 1; PickedStringBrightnessType[PickedStringBrightnessType["resonant"] = resonant] = "resonant"; // 3rd order lowpass, harder corner
		})(PickedStringBrightnessType || (PickedStringBrightnessType = {}));
		const brightnessType =  sustainType == SustainType.bright ? PickedStringBrightnessType.bright : PickedStringBrightnessType.normal;
...
class EnvelopeComputer {
    ...
    // Fade envelopes notable use unscaled values instead of being ties to Envelope Speed.
     __init126() {this.noteSecondsStart = 0.0}
     __init127() {this.noteSecondsStartUnscaled = 0.0}
     __init128() {this.noteSecondsEnd = 0.0}
     __init129() {this.noteSecondsEndUnscaled = 0.0}
     __init130() {this.noteTicksStart = 0.0}
     __init131() {this.noteTicksEnd = 0.0}
     __init132() {this.noteSizeStart = Config.noteSizeMax}
     __init133() {this.noteSizeEnd = Config.noteSizeMax}
     __init134() {this.prevNoteSize = Config.noteSizeMax}
     __init135() {this.nextNoteSize = Config.noteSizeMax}
     __init136() {this._noteSizeFinal = Config.noteSizeMax}
     __init137() {this.prevNoteSecondsStart = 0.0}
     __init138() {this.prevNoteSecondsStartUnscaled = 0.0}
     __init139() {this.prevNoteSecondsEnd = 0.0}
     __init140() {this.prevNoteSecondsEndUnscaled = 0.0}
     __init141() {this.prevNoteTicksStart = 0.0}
     __init142() {this.prevNoteTicksEnd = 0.0}
     __init143() {this._prevNoteSizeFinal = Config.noteSizeMax}

     __init144() {this.prevSlideStart = false}
     __init145() {this.prevSlideEnd = false}
     __init146() {this.nextSlideStart = false}
     __init147() {this.nextSlideEnd = false}
     __init148() {this.prevSlideRatioStart = 0.0}
     __init149() {this.prevSlideRatioEnd = 0.0}
     __init150() {this.nextSlideRatioStart = 0.0}
     __init151() {this.nextSlideRatioEnd = 0.0}

      __init152() {this.envelopeStarts = []}
      __init153() {this.envelopeEnds = []}
      __init154() {this._modifiedEnvelopeIndices = []}
     __init155() {this._modifiedEnvelopeCount = 0}
     __init156() {this.lowpassCutoffDecayVolumeCompensation = 1.0}

    constructor(/*private _perNote: boolean*/) {;EnvelopeComputer.prototype.__init126.call(this);EnvelopeComputer.prototype.__init127.call(this);EnvelopeComputer.prototype.__init128.call(this);EnvelopeComputer.prototype.__init129.call(this);EnvelopeComputer.prototype.__init130.call(this);EnvelopeComputer.prototype.__init131.call(this);EnvelopeComputer.prototype.__init132.call(this);EnvelopeComputer.prototype.__init133.call(this);EnvelopeComputer.prototype.__init134.call(this);EnvelopeComputer.prototype.__init135.call(this);EnvelopeComputer.prototype.__init136.call(this);EnvelopeComputer.prototype.__init137.call(this);EnvelopeComputer.prototype.__init138.call(this);EnvelopeComputer.prototype.__init139.call(this);EnvelopeComputer.prototype.__init140.call(this);EnvelopeComputer.prototype.__init141.call(this);EnvelopeComputer.prototype.__init142.call(this);EnvelopeComputer.prototype.__init143.call(this);EnvelopeComputer.prototype.__init144.call(this);EnvelopeComputer.prototype.__init145.call(this);EnvelopeComputer.prototype.__init146.call(this);EnvelopeComputer.prototype.__init147.call(this);EnvelopeComputer.prototype.__init148.call(this);EnvelopeComputer.prototype.__init149.call(this);EnvelopeComputer.prototype.__init150.call(this);EnvelopeComputer.prototype.__init151.call(this);EnvelopeComputer.prototype.__init152.call(this);EnvelopeComputer.prototype.__init153.call(this);EnvelopeComputer.prototype.__init154.call(this);EnvelopeComputer.prototype.__init155.call(this);EnvelopeComputer.prototype.__init156.call(this);
     ...
     static computeEnvelope(envelope, time, beats, noteSize) {
        switch (envelope.type) {
            ...
            case EnvelopeType.flare: const attack = 0.25 / Math.sqrt(envelope.speed); return time < attack ? time / attack : 1.0 / (1.0 + (time - attack) * envelope.speed);
...
class Tone {
      ...
      __init157() {this.pitches = Array(Config.maxChordSize).fill(0)}
     __init158() {this.pitchCount = 0}
     __init159() {this.chordSize = 0}
     __init160() {this.drumsetPitch = null}
     __init161() {this.note = null}
     __init162() {this.prevNote = null}
     __init163() {this.nextNote = null}
     __init164() {this.prevNotePitchIndex = 0}
     __init165() {this.nextNotePitchIndex = 0}
     __init166() {this.freshlyAllocated = true}
     __init167() {this.atNoteStart = false}
     __init168() {this.isOnLastTick = false} // Whether the tone is finished fading out and ready to be freed.
     __init169() {this.passedEndOfNote = false}
     __init170() {this.forceContinueAtStart = false}
     __init171() {this.forceContinueAtEnd = false}
     __init172() {this.noteStartPart = 0}
     __init173() {this.noteEndPart = 0}
     __init174() {this.ticksSinceReleased = 0}
     __init175() {this.liveInputSamplesHeld = 0}
     __init176() {this.lastInterval = 0}
     __init177() {this.noiseSample = 0.0}
     __init178() {this.stringSustainStart = 0}
     __init179() {this.stringSustainEnd = 0}
      __init180() {this.phases = []}
      __init181() {this.operatorWaves = []}
      __init182() {this.phaseDeltas = []}
      __init183() {this.phaseDeltaScales = []}
     __init184() {this.expression = 0.0}
     __init185() {this.expressionDelta = 0.0}
      __init186() {this.operatorExpressions = []}
      __init187() {this.operatorExpressionDeltas = []}
      __init188() {this.prevPitchExpressions = Array(Config.maxPitchOrOperatorCount).fill(null)}
     __init189() {this.prevVibrato = null}
     __init190() {this.prevStringDecay = null}
     __init191() {this.pulseWidth = 0.0}
     __init192() {this.pulseWidthDelta = 0.0}
     __init193() {this.supersawDynamism = 0.0}
	 __init194() {this.supersawDynamismDelta = 0.0}
	 __init195() {this.supersawUnisonDetunes = []} // These can change over time, but slowly enough that I'm not including corresponding delta values within a tick run.
	 __init196() {this.supersawShape = 0.0}
	 __init197() {this.supersawShapeDelta = 0.0}
	 __init198() {this.supersawDelayLength = 0.0}
	 __init199() {this.supersawDelayLengthDelta = 0.0}
	 __init200() {this.supersawDelayLine = null}
	 __init201() {this.supersawDelayIndex = -1}
	 __init202() {this.supersawPrevPhaseDelta = null}
      __init203() {this.pickedStrings = []}

      __init204() {this.noteFilters = []}
     __init205() {this.noteFilterCount = 0}
     __init206() {this.initialNoteFilterInput1 = 0.0}
     __init207() {this.initialNoteFilterInput2 = 0.0}

     __init208() {this.specialIntervalExpressionMult = 1.0}
      __init209() {this.feedbackOutputs = []}
     __init210() {this.feedbackMult = 0.0}
     __init211() {this.feedbackDelta = 0.0}
     __init212() {this.stereoVolumeLStart = 0.0}
     __init213() {this.stereoVolumeRStart = 0.0}
     __init214() {this.stereoVolumeLDelta = 0.0}
     __init215() {this.stereoVolumeRDelta = 0.0}
     __init216() {this.stereoDelayStart = 0.0}
     __init217() {this.stereoDelayEnd = 0.0}
     __init218() {this.stereoDelayDelta = 0.0}
     __init219() {this.customVolumeStart = 0.0}
     __init220() {this.customVolumeEnd = 0.0}
     __init221() {this.filterResonanceStart = 0.0}
     __init222() {this.filterResonanceDelta = 0.0}
     __init223() {this.isFirstOrder = false}

      __init224() {this.envelopeComputer = new EnvelopeComputer(/*true*/)}

    constructor() {;Tone.prototype.__init157.call(this);Tone.prototype.__init158.call(this);Tone.prototype.__init159.call(this);Tone.prototype.__init160.call(this);Tone.prototype.__init161.call(this);Tone.prototype.__init162.call(this);Tone.prototype.__init163.call(this);Tone.prototype.__init164.call(this);Tone.prototype.__init165.call(this);Tone.prototype.__init166.call(this);Tone.prototype.__init167.call(this);Tone.prototype.__init168.call(this);Tone.prototype.__init169.call(this);Tone.prototype.__init170.call(this);Tone.prototype.__init171.call(this);Tone.prototype.__init172.call(this);Tone.prototype.__init173.call(this);Tone.prototype.__init174.call(this);Tone.prototype.__init175.call(this);Tone.prototype.__init176.call(this);Tone.prototype.__init177.call(this);Tone.prototype.__init178.call(this);Tone.prototype.__init179.call(this);Tone.prototype.__init180.call(this);Tone.prototype.__init181.call(this);Tone.prototype.__init182.call(this);Tone.prototype.__init183.call(this);Tone.prototype.__init184.call(this);Tone.prototype.__init185.call(this);Tone.prototype.__init186.call(this);Tone.prototype.__init187.call(this);Tone.prototype.__init188.call(this);Tone.prototype.__init189.call(this);Tone.prototype.__init190.call(this);Tone.prototype.__init191.call(this);Tone.prototype.__init192.call(this);Tone.prototype.__init193.call(this);Tone.prototype.__init194.call(this);Tone.prototype.__init195.call(this);Tone.prototype.__init196.call(this);Tone.prototype.__init197.call(this);Tone.prototype.__init198.call(this);Tone.prototype.__init199.call(this);Tone.prototype.__init200.call(this);Tone.prototype.__init201.call(this);Tone.prototype.__init202.call(this);Tone.prototype.__init203.call(this);Tone.prototype.__init204.call(this);Tone.prototype.__init205.call(this);Tone.prototype.__init206.call(this);Tone.prototype.__init207.call(this);Tone.prototype.__init208.call(this);Tone.prototype.__init209.call(this);Tone.prototype.__init210.call(this);Tone.prototype.__init211.call(this);Tone.prototype.__init212.call(this);Tone.prototype.__init213.call(this);Tone.prototype.__init214.call(this);Tone.prototype.__init215.call(this);Tone.prototype.__init216.call(this);Tone.prototype.__init217.call(this);Tone.prototype.__init218.call(this);Tone.prototype.__init219.call(this);Tone.prototype.__init220.call(this);Tone.prototype.__init221.call(this);Tone.prototype.__init222.call(this);Tone.prototype.__init223.call(this);Tone.prototype.__init224.call(this);
        this.reset();
    }
...
class InstrumentState {
     __init225() {this.awake = false} // Whether the instrument's effects-processing loop should continue.
     __init226() {this.computed = false} // Whether the effects-processing parameters are up-to-date for the current synth run.
     __init227() {this.tonesAddedInThisTick = false} // Whether any instrument tones are currently active.
     __init228() {this.flushingDelayLines = false} // If no tones were active recently, enter a mode where the delay lines are filled with zeros to reset them for later use.
     __init229() {this.deactivateAfterThisTick = false} // Whether the instrument is ready to be deactivated because the delay lines, if any, are fully zeroed.
     __init230() {this.attentuationProgress = 0.0} // How long since an active tone introduced an input signal to the delay lines, normalized from 0 to 1 based on how long to wait until the delay lines signal will have audibly dissapated.
     __init231() {this.flushedSamples = 0} // How many delay line samples have been flushed to zero.
      __init232() {this.activeTones = new Deque()}
      __init233() {this.activeModTones = new Deque()}
      __init234() {this.releasedTones = new Deque()} // Tones that are in the process of fading out after the corresponding notes ended.
      __init235() {this.liveInputTones = new Deque()} // Tones that are initiated by a source external to the loaded song data.

     __init236() {this.type = InstrumentType.chip}
     __init237() {this.synthesizer = null}
     __init238() {this.wave = null}
     __init239() {this.noisePitchFilterMult = 1.0}
     __init240() {this.unison = null}
     __init241() {this.chord = null}
     __init242() {this.effects = 0}

     __init243() {this.volumeScale = 0}
     __init244() {this.aliases = false}
     __init245() {this.arpTime = 0}
     __init246() {this.vibratoTime = 0}
     __init247() {this.nextVibratoTime = 0}
     __init248() {this.envelopeTime = 0}

     __init249() {this.eqFilterVolume = 1.0}
     __init250() {this.eqFilterVolumeDelta = 0.0}
     __init251() {this.mixVolume = 1.0}
     __init252() {this.mixVolumeDelta = 0.0}
     __init253() {this.delayInputMult = 0.0}
     __init254() {this.delayInputMultDelta = 0.0}

     __init255() {this.distortion = 0.0}
     __init256() {this.distortionDelta = 0.0}
     __init257() {this.distortionDrive = 0.0}
     __init258() {this.distortionDriveDelta = 0.0}
     __init259() {this.distortionFractionalInput1 = 0.0}
     __init260() {this.distortionFractionalInput2 = 0.0}
     __init261() {this.distortionFractionalInput3 = 0.0}
     __init262() {this.distortionPrevInput = 0.0}
     __init263() {this.distortionNextOutput = 0.0}

     __init264() {this.bitcrusherPrevInput = 0.0}
     __init265() {this.bitcrusherCurrentOutput = 0.0}
     __init266() {this.bitcrusherPhase = 1.0}
     __init267() {this.bitcrusherPhaseDelta = 0.0}
     __init268() {this.bitcrusherPhaseDeltaScale = 1.0}
     __init269() {this.bitcrusherScale = 1.0}
     __init270() {this.bitcrusherScaleScale = 1.0}
     __init271() {this.bitcrusherFoldLevel = 1.0}
     __init272() {this.bitcrusherFoldLevelScale = 1.0}

      __init273() {this.eqFilters = []}
     __init274() {this.eqFilterCount = 0}
     __init275() {this.initialEqFilterInput1 = 0.0}
     __init276() {this.initialEqFilterInput2 = 0.0}

     __init277() {this.panningDelayLine = null}
     __init278() {this.panningDelayPos = 0}
     __init279() {this.panningVolumeL = 0.0}
     __init280() {this.panningVolumeR = 0.0}
     __init281() {this.panningVolumeDeltaL = 0.0}
     __init282() {this.panningVolumeDeltaR = 0.0}
     __init283() {this.panningOffsetL = 0.0}
     __init284() {this.panningOffsetR = 0.0}
     __init285() {this.panningOffsetDeltaL = 0.0}
     __init286() {this.panningOffsetDeltaR = 0.0}

     __init287() {this.chorusDelayLineL = null}
     __init288() {this.chorusDelayLineR = null}
     __init289() {this.chorusDelayLineDirty = false}
     __init290() {this.chorusDelayPos = 0}
     __init291() {this.chorusPhase = 0}
     __init292() {this.chorusVoiceMult = 0}
     __init293() {this.chorusVoiceMultDelta = 0}
     __init294() {this.chorusCombinedMult = 0}
     __init295() {this.chorusCombinedMultDelta = 0}

     __init296() {this.echoDelayLineL = null}
     __init297() {this.echoDelayLineR = null}
     __init298() {this.echoDelayLineDirty = false}
     __init299() {this.echoDelayPos = 0}
     __init300() {this.echoDelayOffsetStart = 0}
     __init301() {this.echoDelayOffsetEnd = null}
     __init302() {this.echoDelayOffsetRatio = 0.0}
     __init303() {this.echoDelayOffsetRatioDelta = 0.0}
     __init304() {this.echoMult = 0.0}
     __init305() {this.echoMultDelta = 0.0}
     __init306() {this.echoShelfA1 = 0.0}
     __init307() {this.echoShelfB0 = 0.0}
     __init308() {this.echoShelfB1 = 0.0}
     __init309() {this.echoShelfSampleL = 0.0}
     __init310() {this.echoShelfSampleR = 0.0}
     __init311() {this.echoShelfPrevInputL = 0.0}
     __init312() {this.echoShelfPrevInputR = 0.0}

     __init313() {this.reverbDelayLine = null}
     __init314() {this.reverbDelayLineDirty = false}
     __init315() {this.reverbDelayPos = 0}
     __init316() {this.reverbMult = 0.0}
     __init317() {this.reverbMultDelta = 0.0}
     __init318() {this.reverbShelfA1 = 0.0}
     __init319() {this.reverbShelfB0 = 0.0}
     __init320() {this.reverbShelfB1 = 0.0}
     __init321() {this.reverbShelfSample0 = 0.0}
     __init322() {this.reverbShelfSample1 = 0.0}
     __init323() {this.reverbShelfSample2 = 0.0}
     __init324() {this.reverbShelfSample3 = 0.0}
     __init325() {this.reverbShelfPrevInput0 = 0.0}
     __init326() {this.reverbShelfPrevInput1 = 0.0}
     __init327() {this.reverbShelfPrevInput2 = 0.0}
     __init328() {this.reverbShelfPrevInput3 = 0.0}

    //public readonly envelopeComputer: EnvelopeComputer = new EnvelopeComputer(false);

      __init329() {this.spectrumWave = new SpectrumWaveState()}
      __init330() {this.harmonicsWave = new HarmonicsWaveState()}
      __init331() {this.drumsetSpectrumWaves = []}

    constructor() {;InstrumentState.prototype.__init225.call(this);InstrumentState.prototype.__init226.call(this);InstrumentState.prototype.__init227.call(this);InstrumentState.prototype.__init228.call(this);InstrumentState.prototype.__init229.call(this);InstrumentState.prototype.__init230.call(this);InstrumentState.prototype.__init231.call(this);InstrumentState.prototype.__init232.call(this);InstrumentState.prototype.__init233.call(this);InstrumentState.prototype.__init234.call(this);InstrumentState.prototype.__init235.call(this);InstrumentState.prototype.__init236.call(this);InstrumentState.prototype.__init237.call(this);InstrumentState.prototype.__init238.call(this);InstrumentState.prototype.__init239.call(this);InstrumentState.prototype.__init240.call(this);InstrumentState.prototype.__init241.call(this);InstrumentState.prototype.__init242.call(this);InstrumentState.prototype.__init243.call(this);InstrumentState.prototype.__init244.call(this);InstrumentState.prototype.__init245.call(this);InstrumentState.prototype.__init246.call(this);InstrumentState.prototype.__init247.call(this);InstrumentState.prototype.__init248.call(this);InstrumentState.prototype.__init249.call(this);InstrumentState.prototype.__init250.call(this);InstrumentState.prototype.__init251.call(this);InstrumentState.prototype.__init252.call(this);InstrumentState.prototype.__init253.call(this);InstrumentState.prototype.__init254.call(this);InstrumentState.prototype.__init255.call(this);InstrumentState.prototype.__init256.call(this);InstrumentState.prototype.__init257.call(this);InstrumentState.prototype.__init258.call(this);InstrumentState.prototype.__init259.call(this);InstrumentState.prototype.__init260.call(this);InstrumentState.prototype.__init261.call(this);InstrumentState.prototype.__init262.call(this);InstrumentState.prototype.__init263.call(this);InstrumentState.prototype.__init264.call(this);InstrumentState.prototype.__init265.call(this);InstrumentState.prototype.__init266.call(this);InstrumentState.prototype.__init267.call(this);InstrumentState.prototype.__init268.call(this);InstrumentState.prototype.__init269.call(this);InstrumentState.prototype.__init270.call(this);InstrumentState.prototype.__init271.call(this);InstrumentState.prototype.__init272.call(this);InstrumentState.prototype.__init273.call(this);InstrumentState.prototype.__init274.call(this);InstrumentState.prototype.__init275.call(this);InstrumentState.prototype.__init276.call(this);InstrumentState.prototype.__init277.call(this);InstrumentState.prototype.__init278.call(this);InstrumentState.prototype.__init279.call(this);InstrumentState.prototype.__init280.call(this);InstrumentState.prototype.__init281.call(this);InstrumentState.prototype.__init282.call(this);InstrumentState.prototype.__init283.call(this);InstrumentState.prototype.__init284.call(this);InstrumentState.prototype.__init285.call(this);InstrumentState.prototype.__init286.call(this);InstrumentState.prototype.__init287.call(this);InstrumentState.prototype.__init288.call(this);InstrumentState.prototype.__init289.call(this);InstrumentState.prototype.__init290.call(this);InstrumentState.prototype.__init291.call(this);InstrumentState.prototype.__init292.call(this);InstrumentState.prototype.__init293.call(this);InstrumentState.prototype.__init294.call(this);InstrumentState.prototype.__init295.call(this);InstrumentState.prototype.__init296.call(this);InstrumentState.prototype.__init297.call(this);InstrumentState.prototype.__init298.call(this);InstrumentState.prototype.__init299.call(this);InstrumentState.prototype.__init300.call(this);InstrumentState.prototype.__init301.call(this);InstrumentState.prototype.__init302.call(this);InstrumentState.prototype.__init303.call(this);InstrumentState.prototype.__init304.call(this);InstrumentState.prototype.__init305.call(this);InstrumentState.prototype.__init306.call(this);InstrumentState.prototype.__init307.call(this);InstrumentState.prototype.__init308.call(this);InstrumentState.prototype.__init309.call(this);InstrumentState.prototype.__init310.call(this);InstrumentState.prototype.__init311.call(this);InstrumentState.prototype.__init312.call(this);InstrumentState.prototype.__init313.call(this);InstrumentState.prototype.__init314.call(this);InstrumentState.prototype.__init315.call(this);InstrumentState.prototype.__init316.call(this);InstrumentState.prototype.__init317.call(this);InstrumentState.prototype.__init318.call(this);InstrumentState.prototype.__init319.call(this);InstrumentState.prototype.__init320.call(this);InstrumentState.prototype.__init321.call(this);InstrumentState.prototype.__init322.call(this);InstrumentState.prototype.__init323.call(this);InstrumentState.prototype.__init324.call(this);InstrumentState.prototype.__init325.call(this);InstrumentState.prototype.__init326.call(this);InstrumentState.prototype.__init327.call(this);InstrumentState.prototype.__init328.call(this);InstrumentState.prototype.__init329.call(this);InstrumentState.prototype.__init330.call(this);InstrumentState.prototype.__init331.call(this);
        for (let i = 0; i < Config.drumCount; i++) {
     ...
     allocateNecessaryBuffers(synth, instrument, samplesPerTick) {
        ...
        if (effectsIncludeEcho(instrument.effects)) {
            ...
            const safeEchoDelaySteps = Math.max(Config.echoDelayRange >> 1, (instrument.echoDelay + 1)); // The delay may be very short now, but if it increases later make sure we have enough sample history.
     ...
     deactivate() {
        ...
        if (this.panningDelayLine != null) for (let i = 0; i < this.panningDelayLine.length; i++) this.panningDelayLine[i] = 0.0;
     ...
     compute(synth, instrument, samplesPerTick, roundedSamplesPerTick, tone, channelIndex, instrumentIndex) {
        ...
        if (usesBitcrusher) {
            let freqSettingStart = instrument.bitcrusherFreq /** Math.sqrt(envelopeStarts[InstrumentAutomationIndex.bitcrusherFrequency])*/;
            let freqSettingEnd = instrument.bitcrusherFreq /** Math.sqrt(envelopeEnds[  InstrumentAutomationIndex.bitcrusherFrequency])*/;
            ...
            let quantizationSettingStart = instrument.bitcrusherQuantization /** Math.sqrt(envelopeStarts[InstrumentAutomationIndex.bitcrusherQuantization])*/;
            let quantizationSettingEnd = instrument.bitcrusherQuantization /** Math.sqrt(envelopeEnds[  InstrumentAutomationIndex.bitcrusherQuantization])*/;
            ...
            const basePitch = Config.keys[synth.song.key].basePitch; // TODO: What if there's a key change mid-song?
...
class ChannelState {constructor() { ChannelState.prototype.__init332.call(this);ChannelState.prototype.__init333.call(this);ChannelState.prototype.__init334.call(this); }
      __init332() {this.instruments = []}
     __init333() {this.muted = false}
     __init334() {this.singleSeamlessInstrument = null} // Seamless tones from a pattern with a single instrument can be transferred to a different single seamless instrument in the next pattern.
}
...
export class Synth {
     ...
     warmUpSynthesizer(song) {
        ...
        // BoneBox needs to run synth functions for at least one sample (for JIT purposes)
    ...
    // TODO: This kind of check is mirrored in SongEditor.ts' whenUpdated. Creates a lot of redundancy for adding new mods. Can be moved into new properties for mods, to avoid this later.
     ...
     __init335() {this.samplesPerSecond = 44100}
    ...
    // TODO: reverb
     ...
     __init336() {this.song = null}
     __init337() {this.preferLowerLatency = false} // enable when recording performances from keyboard or MIDI. Takes effect next time you activate audio.
     __init338() {this.anticipatePoorPerformance = false} // enable on mobile devices to reduce audio stutter glitches. Takes effect next time you activate audio.
     __init339() {this.liveInputDuration = 0}
     __init340() {this.liveBassInputDuration = 0}
     __init341() {this.liveInputStarted = false}
     __init342() {this.liveBassInputStarted = false}
     __init343() {this.liveInputPitches = []}
     __init344() {this.liveBassInputPitches = []}
     __init345() {this.liveInputChannel = 0}
     __init346() {this.liveBassInputChannel = 0}
     __init347() {this.liveInputInstruments = []}
     __init348() {this.liveBassInputInstruments = []}
     __init349() {this.loopRepeatCount = -1}
     __init350() {this.volume = 1.0}
     __init351() {this.enableMetronome = false}
     __init352() {this.countInMetronome = false}
     __init353() {this.renderingSong = false}
     __init354() {this.heldMods = []}
     __init355() {this.wantToSkip = false}
     __init356() {this.playheadInternal = 0.0}
     __init357() {this.bar = 0}
     __init358() {this.prevBar = null}
     __init359() {this.nextBar = null}
     __init360() {this.beat = 0}
     __init361() {this.part = 0}
     __init362() {this.tick = 0}
     __init363() {this.isAtStartOfTick = true}
     __init364() {this.isAtEndOfTick = true}
     __init365() {this.tickSampleCountdown = 0}
     __init366() {this.modValues = []}
     __init367() {this.modInsValues = []}
     __init368() {this.nextModValues = []}
     __init369() {this.nextModInsValues = []}
     __init370() {this.isPlayingSong = false}
     __init371() {this.isRecording = false}
     __init372() {this.liveInputEndTime = 0.0}
     __init373() {this.browserAutomaticallyClearsAudioBuffer = true} // Assume true until proven otherwise. Older Chrome does not clear the buffer so it needs to be cleared manually.

     static  __initStatic7() {this.tempFilterStartCoefficients = new FilterCoefficients()}
     static  __initStatic8() {this.tempFilterEndCoefficients = new FilterCoefficients()}
     __init374() {this.tempDrumSetControlPoint = new FilterControlPoint()}
     __init375() {this.tempFrequencyResponse = new FrequencyResponse()}
     __init376() {this.loopBarStart = -1}
     __init377() {this.loopBarEnd = -1}

     static  __initStatic9() {this.fmSynthFunctionCache = {}}
     static  __initStatic10() {this.effectsFunctionCache = Array(1 << 7).fill(undefined)} // keep in sync with the number of post-process effects.
     static  __initStatic11() {this.pickedStringFunctionCache = Array(3).fill(undefined)} // keep in sync with the number of unison voices.

      __init378() {this.channels = []}
      __init379() {this.tonePool = new Deque()}
      __init380() {this.tempMatchedPitchTones = Array(Config.maxChordSize).fill(null)}

     __init381() {this.startedMetronome = false}
     __init382() {this.metronomeSamplesRemaining = -1}
     __init383() {this.metronomeAmplitude = 0.0}
     __init384() {this.metronomePrevAmplitude = 0.0}
     __init385() {this.metronomeFilter = 0.0}
     __init386() {this.limit = 0.0}

     __init387() {this.tempMonoInstrumentSampleBuffer = null}

     __init388() {this.audioCtx = null}
     __init389() {this.scriptNode = null}
    ...
    constructor(song = null) {;Synth.prototype.__init335.call(this);Synth.prototype.__init336.call(this);Synth.prototype.__init337.call(this);Synth.prototype.__init338.call(this);Synth.prototype.__init339.call(this);Synth.prototype.__init340.call(this);Synth.prototype.__init341.call(this);Synth.prototype.__init342.call(this);Synth.prototype.__init343.call(this);Synth.prototype.__init344.call(this);Synth.prototype.__init345.call(this);Synth.prototype.__init346.call(this);Synth.prototype.__init347.call(this);Synth.prototype.__init348.call(this);Synth.prototype.__init349.call(this);Synth.prototype.__init350.call(this);Synth.prototype.__init351.call(this);Synth.prototype.__init352.call(this);Synth.prototype.__init353.call(this);Synth.prototype.__init354.call(this);Synth.prototype.__init355.call(this);Synth.prototype.__init356.call(this);Synth.prototype.__init357.call(this);Synth.prototype.__init358.call(this);Synth.prototype.__init359.call(this);Synth.prototype.__init360.call(this);Synth.prototype.__init361.call(this);Synth.prototype.__init362.call(this);Synth.prototype.__init363.call(this);Synth.prototype.__init364.call(this);Synth.prototype.__init365.call(this);Synth.prototype.__init366.call(this);Synth.prototype.__init367.call(this);Synth.prototype.__init368.call(this);Synth.prototype.__init369.call(this);Synth.prototype.__init370.call(this);Synth.prototype.__init371.call(this);Synth.prototype.__init372.call(this);Synth.prototype.__init373.call(this);Synth.prototype.__init374.call(this);Synth.prototype.__init375.call(this);Synth.prototype.__init376.call(this);Synth.prototype.__init377.call(this);Synth.prototype.__init378.call(this);Synth.prototype.__init379.call(this);Synth.prototype.__init380.call(this);Synth.prototype.__init381.call(this);Synth.prototype.__init382.call(this);Synth.prototype.__init383.call(this);Synth.prototype.__init384.call(this);Synth.prototype.__init385.call(this);Synth.prototype.__init386.call(this);Synth.prototype.__init387.call(this);Synth.prototype.__init388.call(this);Synth.prototype.__init389.call(this);Synth.prototype.__init390.call(this);
    ...
    // Force a modulator to be held at the given volumeStart for a brief duration.
     ...
     __init390() {this.audioProcessCallback = (audioProcessingEvent) => {
    ...
    // Computes mod note position at the start and end of the window and "plays" the mod tone, setting appropriate mod data.
     ...
     computeTone(song, channelIndex, samplesPerTick, tone, released, shouldFadeOutFast) {
        ...
        if (instrument.type == InstrumentType.fm) {
            ...
            const expressionStart = baseExpression * sineExpressionBoost * noteFilterExpression * fadeExpressionStart * chordExpressionStart * envelopeStarts[EnvelopeComputeIndex.noteVolume];
            const expressionEnd = baseExpression * sineExpressionBoost * noteFilterExpression * fadeExpressionEnd * chordExpressionEnd * envelopeEnds[EnvelopeComputeIndex.noteVolume];
            ...
            if (instrument.type == InstrumentType.chip || instrument.type == InstrumentType.customChipWave || instrument.type == InstrumentType.harmonics || instrument.type == InstrumentType.pickedString) {
                ...
                const voiceCountExpression = (instrument.type == InstrumentType.pickedString) ? 1 : unison.voices / 2.0;
     ...
     static effectsSynth(synth, outputDataL, outputDataR, bufferIndex, runLength, instrumentState) {
        ...
        let signature = 0; if (usesDistortion) signature = signature | 1;
     ...
     static __initStatic12() {this.fmSourceTemplate = (`
		const data = synth.tempMonoInstrumentSampleBuffer;
     ...
     static __initStatic13() {this.operatorSourceTemplate = (`
...
} Synth.__initStatic7(); Synth.__initStatic8(); Synth.__initStatic9(); Synth.__initStatic10(); Synth.__initStatic11(); Synth.__initStatic12(); Synth.__initStatic13();

// When compiling synth.ts as a standalone module named "beepbox", expose these classes as members to JavaScript:
export { FilterType, EnvelopeType, InstrumentType, Config } ;
